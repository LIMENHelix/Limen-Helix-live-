/**
 * api/defense-markets.js — cached batch quotes for the curated defense ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/defense-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (defense:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'defense:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'LMT','RTX','NOC','GD','BA','LHX','HII','LDOS','BAH','KTOS','AVAV',  // defense primes & contractors
  'HWM','TDG','AXON','CW','HEI','TXT',           // aerospace/defense components & systems
  'ITA','PPA','XAR'                                // aerospace-defense ETFs (context)
];
