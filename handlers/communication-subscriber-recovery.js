...
var handler = createHandler(); module.exports = require('../lib/heartbeat').wrap('communication-subscriber-recovery', handler); module.exports.createHandler = createHandler;
