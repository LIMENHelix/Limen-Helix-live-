/**
 * api/intelligence-markets.js — cached batch quotes for the curated intelligence ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/intelligence-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (intelligence:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'intelligence:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'PLTR','BAH','LDOS','CACI','SAIC','KBR',  // IC services & analytics primes
  'VRNT','NICE','VRSK','MAXR','NPSNY',        // surveillance/analytics/GEOINT/data
  'ITA','PPA'                                   // aerospace-defense ETFs (context)
];
