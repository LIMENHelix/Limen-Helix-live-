/**
 * api/population-markets.js — cached batch quotes for the curated population ticker set.
 * Mirror of energy-markets.js. Populational data only — NOT investment advice.
 *
 * GET /api/population-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (population:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'population:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'WELL','VTR','OHI','SBRA',  // senior-living / aging-demographics REITs
  'DHI','LEN','PHM','NVR','AVB','INVH',  // homebuilders / residential (household formation)
  'XLRE','ITB'                       // real-estate / homebuild ETFs (context)
];
