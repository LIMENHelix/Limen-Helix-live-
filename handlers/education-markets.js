/**
 * api/education-markets.js — cached batch quotes for the curated education ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/education-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (education:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'education:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'CHGG','COUR','DUOL','TWOU',  // edtech / online learning
  'LRN','ATGE','LOPE','STRA','LAUR','UTI',  // K-12 / higher-ed / for-profit / vocational
  'PSO.L','SCHL'                       // publishing / curriculum (context)
];
