/**
 * api/law-markets.js — cached batch quotes for the curated law ticker set.
 * Mirror of energy-markets.js. Lawal data only — NOT investment advice.
 *
 * GET /api/law-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (law:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'law:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'RELX','TRI','VERX','CSGP','VRSK',  // legal info / compliance / risk & data
  'ACN','FCN','EFX'                  // legal/regulatory consulting & screening (context)
];
