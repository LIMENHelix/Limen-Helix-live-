/**
 * api/industry-markets.js — cached batch quotes for the curated industry ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/industry-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (industry:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'industry:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'CAT','DE','GE','HON','MMM','EMR',  // capital goods / diversified industrials
  'ITW','ETN','PH','ROK','DOV','GEV',         // machinery / automation / electrical equipment
  'XLI','VIS','XAR'                            // industrial ETFs (context)
];
