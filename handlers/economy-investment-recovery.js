...
var Executor = require('../lib/economy-investment-executor.js'), Recovery = require('../lib/economy-investment-recovery.js');
module.exports = async function handler(req, res) {
  ...
  } catch (error) { res.statusCode = 503; return res.end(JSON.stringify({ ok: false, error: 'economy-investment-recovery-unavailable', detail: String(error && error.message || error), liveMoney: false })); }
};
