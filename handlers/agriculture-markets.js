/**
 * api/agriculture-markets.js — cached batch quotes for the curated agriculture ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/agriculture-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (agriculture:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'agriculture:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'ADM','BG','INGR','TSN','CAG',  // agribusiness / processing / protein
  'CTVA','NTR','MOS','CF','FMC',         // seeds / fertilizer / crop inputs
  'DE','AGCO','CNHI',                  // farm equipment / machinery
  'MOO','DBA'                            // agriculture ETFs (context)
];
