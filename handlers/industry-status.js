/**
 * industry-status.js — per-deal CRM state for the Industry desk (plant closings). The operator
 * tracks New -> Contacted -> Pitched buyer -> Deal -> Closed / Dead. Mirrors homestead-status.
 *
