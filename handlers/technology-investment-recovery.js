...
var Executor = require('../lib/technology-investment-executor.js'), Recovery = require('../lib/technology-investment-recovery.js');
module.exports = async function handler(req, res) {
  ...
  } catch (error) { res.statusCode = 503; return res.end(JSON.stringify({ ok: false, error: 'technology-investment-recovery-unavailable', detail: String(error && error.message || error), liveMoney: false })); }
};
