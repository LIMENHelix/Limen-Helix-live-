/**
 * api/religion-markets.js — cached batch quotes for the curated religion ticker set.
 * Mirror of energy-markets.js. Religional data only — NOT investment advice.
 *
 * GET /api/religion-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (religion:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'religion:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'BIBL','WWJD','FOVL','KOCG'  // values-screened / faith-based funds (context — religion is indicator-based, not a sector)
];
