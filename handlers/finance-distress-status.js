/**
 * finance-distress-status.js — per-deal CRM state for the Finance distress desk. The operator
 * tracks New -> Contacted -> Feed sent -> Deal -> Closed / Dead. Mirrors homestead-status.
 *
...
var SKEY = 'finance:distress:status';
