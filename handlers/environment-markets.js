/**
 * api/environment-markets.js — cached batch quotes for the curated environment ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/environment-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (environment:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'environment:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'WM','RSG','WCN','CWST','CLH','DAR',  // waste / recycling / remediation
  'AWK','WTRG','XYL','VLTO','ECL','TTEK',         // water / treatment / env-services
  'LIN','APD','FSLR','ENPH',                  // industrial gas / clean-tech
  'ICLN','PBW'                                  // climate/clean ETFs (context)
];
