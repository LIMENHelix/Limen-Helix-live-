...
var handler = createHandler(); module.exports = require('../lib/heartbeat').wrap('culture-subscriber-outcome-observer', handler); module.exports.createHandler = createHandler;
