...
var handler = createHandler(); module.exports = require('../lib/heartbeat').wrap('communication-subscriber-outcome-observer', handler); module.exports.createHandler = createHandler;
