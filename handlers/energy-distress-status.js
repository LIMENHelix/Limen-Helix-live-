/**
 * energy-distress-status.js — per-deal CRM state for the Energy L1 broker desk. Operator tracks
 * New -> Contacted -> Matched -> Deal -> Closed / Dead. Mirrors finance-distress-status.
 * GET ?key= -> { ok, statuses }. POST { key, dealKey, status?, note?, revenue? }. Admin-only.
 */
var db = require('../lib/limen-db');
var SKEY = 'energy:distress:status';
