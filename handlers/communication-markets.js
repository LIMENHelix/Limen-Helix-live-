/**
 * api/communication-markets.js — cached batch quotes for the curated communication ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/communication-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (communication:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'communication:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'VZ','T','TMUS','CMCSA','CHTR',  // telecom / cable / broadband
  'CSCO','ANET','AMT','CCI','SBAC',         // network gear / tower infrastructure
  'NWSA','NYT','META','GOOGL',             // media / news / platforms
  'XLC','IYZ'                            // comms ETFs (context)
];
