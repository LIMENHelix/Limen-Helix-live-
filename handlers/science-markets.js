/**
 * api/science-markets.js — cached batch quotes for the curated science ticker set.
 * Mirror of energy-markets.js. Scienceal data only — NOT investment advice.
 *
 * GET /api/science-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (science:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'science:markets:v1';
var TTL_MS = 15 * 60 * 1000;

var TICKERS = [
  'TMO','DHR','A','MTD','WAT',  // life-science tools & instruments
  'ILMN','BIO','RVTY','BRKR',           // genomics / analysis / spectroscopy
  'IQV','ICLR','MEDP',                  // CROs / research services
  'XLV','ARKG'                        // life-science / genomics ETFs (context)
];
