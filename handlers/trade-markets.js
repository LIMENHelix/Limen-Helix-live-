/**
 * api/trade-markets.js — cached batch quotes for the curated trade ticker set.
 * Mirror of energy-markets.js. Educational data only — NOT investment advice.
 *
 * GET /api/trade-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (trade:markets:v1) 15 min, stale-on-failure.
 */
