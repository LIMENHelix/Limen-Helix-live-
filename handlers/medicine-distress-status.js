/**
 * medicine-distress-status.js — per-deal CRM state for the Medicine distress desk. The operator tracks
 * New -> Contacted -> Feed sent -> Deal -> Closed / Dead. Mirrors finance-distress-status.
 *
...
var SKEY = 'medicine:distress:status';
