/**
 * api/economy-markets.js — cached batch quotes for broad-market macro proxies (the economy pulse).
 * Mirror of energy-markets.js, but ECONOMY binds to MACRO PROXIES (indices/treasuries/commodities/
 * dollar/volatility), not single-company tickers. Educational data only — NOT investment advice.
 *
 * GET /api/economy-markets → { ok, updated, cached, quotes: { SYM: {price, changePct} } }
 * Source: Yahoo Finance v8 (public, no key). Cached in Redis (economy:markets:v1) 15 min, stale-on-failure.
 */
var db = require('../lib/limen-db');

var CACHE_KEY = 'economy:markets:v1';
