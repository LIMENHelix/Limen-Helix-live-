...
var B14 = require('../lib/tradier-b14.js'), Executor = require('../lib/energy-investment-executor.js'), Observer = require('../lib/autofire-investment-observer.js');
var Outcome = require('./limen-outcome.js');
var HISTORY_PREFIX = 'energy_investment_observation:', HISTORY_CAP = 3000;
...
function createHandler(deps) {
  ...
  return async function handler(req, res) {
    ...
    try {
      ...
      return json(res, failures.length ? 503 : 200, { ok: failures.length === 0, schemaVersion: 'energy-investment-observer-cycle/1.0', productDomain: 'energy', ownerDomain: 'energy',
    ...
    } catch (error) { return json(res, 503, { ok: false, error: 'energy-investment-observer-unavailable', detail: String(error && error.message || error), orderSubmissionCalls: 0, liveMoney: false }); }
  };
}
var handler = createHandler(); module.exports = require('../lib/heartbeat').wrap('energy-investment-outcome-observer', handler); module.exports.createHandler = createHandler;
