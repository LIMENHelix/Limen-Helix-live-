 ...
 *   p3 (instability)   → grant         (turnaround capital — non-dilutive)
 *   p4 (compression)   → patent        (defensive IP moat while under pressure)
 *   p5 (endurance)     → franchise     (replicable model — rollup opportunity)
 *   p6 (recovery)      → franchise     (post-pain replication window)
 ...
 *   p8 (decay)         → sba           (smaller turnaround capital, less dilution)
