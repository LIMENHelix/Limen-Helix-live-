...
const HANDLERS = {
  ...
  'homestead-read': require('../handlers/homestead-read'),
  'homestead-chat': require('../handlers/homestead-chat'),
  'homestead-events': require('../handlers/homestead-events'),
  ...
  'culture-revenue-fulfillment': require('../handlers/culture-revenue-fulfillment'),
  'culture-subscriber-outcome-observer': require('../handlers/culture-subscriber-outcome-observer'),
  'culture-subscriber-recovery': require('../handlers/culture-subscriber-recovery'),
  'education-revenue-fulfillment': require('../handlers/education-revenue-fulfillment'),
  'education-subscriber-outcome-observer': require('../handlers/education-subscriber-outcome-observer'),
  'education-subscriber-recovery': require('../handlers/education-subscriber-recovery'),
  'communication-revenue-fulfillment': require('../handlers/communication-revenue-fulfillment'),
  'communication-subscriber-outcome-observer': require('../handlers/communication-subscriber-outcome-observer'),
  'communication-subscriber-recovery': require('../handlers/communication-subscriber-recovery'),
  'medicine-revenue-fulfillment': require('../handlers/medicine-revenue-fulfillment'),
  'medicine-subscriber-outcome-observer': require('../handlers/medicine-subscriber-outcome-observer'),
