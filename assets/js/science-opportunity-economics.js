/**
 * science-opportunity-economics.js — Economics Preview per Opportunity Card
 *
 * Injects a small economics block into each Science opportunity card
 * showing estimated value, operator payout, platform share, time window.
 * Science-scoped only. No backend.
 *
 * Depends on: science-compensation.js
 * Namespace: window.LIMENScience.economy.economics
 */
(function () {
  'use strict';
  ...
  window.LIMENScience.economy.economics = {
