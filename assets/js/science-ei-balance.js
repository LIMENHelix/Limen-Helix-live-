/**
 * science-ei-balance.js — Excitation/Inhibition balance controller for the Science brain.
 *
 ...
 *
 * Dual export: window.ScienceEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Science brain state, defensively. Never throws.
  ...
  if (root) root.ScienceEIBalance = API;
