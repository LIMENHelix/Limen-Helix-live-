/**
 * culture-ei-balance.js — Excitation/Inhibition balance controller for the Culture brain.
 *
 ...
 *
 * Dual export: window.CultureEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Culture brain state, defensively. Never throws.
  ...
  if (root) root.CultureEIBalance = API;
