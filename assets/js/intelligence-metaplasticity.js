/*
 * intelligence-metaplasticity.js  — ADDITIVE meta-controller  (THE NEW STRATEGY)
 * ----------------------------------------------------------------------------
 * METAPLASTICITY build-target — the capstone that makes Intelligence's neuro-substrate SELF-TUNING.
 ...
 *   - offline down-scaling factor      (intelligence-offline-maintenance.js)
 *   - refractory absolute window       (intelligence-refractory-limiter.js)
 *   - prediction-error threshold       (intelligence-prediction-error-compressor.js)
 ...
 * no adaptation (returns inputs unchanged). Volatility is caller-supplied (Intelligence has no time
...
(function (root) {
  ...
  function adaptParams(current, params) {
    ...
    return {
      ...
      note: 'Pure. Applies nothing. gain operator-set; volatility caller-supplied (Intelligence has no time series).'
    };
  }

  var API = { adaptParams: adaptParams, DEFAULTS: DEFAULTS };
  if (typeof module !== 'undefined' && module.exports) module.exports = API;
  if (root && !root.IntelligenceMetaplasticity) root.IntelligenceMetaplasticity = API;
