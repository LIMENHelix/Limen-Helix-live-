/**
 * governance-claim-flow.js — Governance Domain Claim Acceptance Flow
 * Namespace: window.LIMENGovernance.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Governance Opportunity</div>';
    ...
    h += '<span class="ecf-accept-text">I understand this is an Governance-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with FERPA, COPPA, accreditation, and student-data protection rules where applicable.</span></label>';
  ...
  window.addEventListener('limen:governance-claim-update', function () { setTimeout(injectIntoCards, 100); });

  window.LIMENGovernance.economy.claimFlow = { openClaimModal: openClaimModal, injectIntoCards: injectIntoCards };
  console.log('[GovernanceClaimFlow] Loaded');
})();
