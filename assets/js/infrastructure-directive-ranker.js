/**
 * infrastructure-directive-ranker.js — Score and rank extracted directive candidates
 *
 ...
 * Exposes: window.LIMENInfrastructureDirectiveRanker
 */
(function () {
  'use strict';
  ...
  var MECHANISMS = {
    supply_disruption:      { label: 'Supply Disruption',       signals: ['supply', 'shortage', 'disruption', 'scarcity', 'outage', 'shut down', 'shutdown', 'materials', 'steel', 'cement', 'aggregate', 'lumber', 'asphalt', 'backorder', 'lead time', 'procurement'] },
    cost_escalation:        { label: 'Cost Escalation',         signals: ['cost', 'price', 'budget', 'overrun', 'escalat', 'inflation', 'bid', 'estimate', 'contingency', 'change order', 'prevailing wage', 'labor cost', 'material cost'] },
    contract_mispricing:    { label: 'Contract Mispricing',     signals: ['contract', 'procurement', 'bid', 'renegotiat', 'settlement', 'bonding', 'surety', 'liquidated damages', 'scope change', 'claim', 'dispute', 'warranty'] },
    logistics_constraint:   { label: 'Logistics Bottleneck',    signals: ['transport', 'throughput', 'routing', 'bottleneck', 'congestion', 'capacity', 'port', 'rail', 'truck', 'logistics', 'haul', 'delivery', 'staging', 'right of way', 'detour', 'lane closure'] },
    structural_degradation: { label: 'Structural Degradation',  signals: ['degradation', 'deteriorat', 'corrosion', 'fatigue', 'crack', 'spall', 'erosion', 'scour', 'settlement', 'seismic', 'load rating', 'deficient', 'structurally deficient', 'functionally obsolete', 'condition rating'] },
    maintenance_backlog:    { label: 'Maintenance Backlog',     signals: ['maintenance', 'deferred', 'backlog', 'repair', 'rehabilitation', 'replacement', 'lifecycle', 'asset management', 'inspection', 'assessment', 'condition', 'useful life', 'end of life', 'capital improvement'] },
    capacity_strain:        { label: 'Capacity Strain',         signals: ['capacity', 'demand', 'load', 'peak', 'overload', 'utilization', 'throughput', 'level of service', 'queue', 'delay', 'congestion', 'volume', 'growth', 'expansion', 'widening'] },
    infrastructure_stress:  { label: 'Infrastructure Stress',   signals: ['infrastructure', 'grid', 'transmission', 'distribution', 'substation', 'transformer', 'water main', 'sewer', 'stormwater', 'bridge', 'tunnel', 'dam', 'levee', 'resilience', 'hardening', 'redundancy', 'fault', 'blackout', 'brownout', 'service interruption'] },
    policy_response:        { label: 'Policy Response',         signals: ['regulatory', 'regulation', 'policy', 'mandate', 'compliance', 'permit', 'zoning', 'environmental review', 'NEPA', 'stimulus', 'infrastructure bill', 'IIJA', 'BIL', 'federal funding', 'formula', 'discretionary grant', 'PPP', 'public-private'] },
    funding_gap:            { label: 'Funding Gap',             signals: ['funding', 'budget', 'appropriation', 'bond', 'municipal bond', 'revenue bond', 'general obligation', 'tax', 'toll', 'user fee', 'rate base', 'capital plan', 'CIP', 'fiscal', 'shortfall', 'deficit', 'sequestration'] }
  };

  // Which mechanisms are VALID for each diagnosis
  var DX_VALID_MECHANISMS = {
    'GRID_DEGRADATION':        ['infrastructure_stress', 'structural_degradation', 'maintenance_backlog', 'capacity_strain', 'policy_response'],
    'SUPPLY_CHAIN_BOTTLENECK': ['supply_disruption', 'logistics_constraint', 'cost_escalation', 'contract_mispricing'],
    'CAPACITY_OVERLOAD':       ['capacity_strain', 'infrastructure_stress', 'logistics_constraint', 'funding_gap'],
    'FUNDING_COLLAPSE':        ['funding_gap', 'policy_response', 'cost_escalation', 'contract_mispricing'],
    'MAINTENANCE_DEFICIT':     ['maintenance_backlog', 'structural_degradation', 'infrastructure_stress', 'supply_disruption'],
    'CYBER_PHYSICAL_ATTACK':   ['infrastructure_stress', 'supply_disruption', 'policy_response', 'capacity_strain']
  };
  ...
  function rank(directives) {
    ...
    console.log('[InfrastructureDirectiveRanker] Ranked ' + directives.length + '. Top: ' +
  ...
  window.LIMENInfrastructureDirectiveRanker = { rank: rank };
})();
