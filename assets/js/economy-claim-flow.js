/**
 * economy-claim-flow.js — Economy Domain Claim Acceptance Flow
 *
 * Adds CLAIM button to Economy opportunity cards. On click, opens
 * modal requiring acceptance of framework terms before creating
 * a claim record. Economy-scoped only. No backend.
 *
 * Depends on: economy-compensation.js, economy-claim-ledger.js
 * Namespace: window.LIMENEconomy.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function injectStyles() {
    ...
    s.textContent = [
      ...
      '.ecf-btn-cancel:hover{color:#C9A94E;border-color:rgba(201,169,78,0.3)}',
      ...
      '.ecf-claim-btn:hover{background:rgba(201,169,78,0.15);border-color:rgba(201,169,78,0.4)}',
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Economy Opportunity</div>';

    // 1. Opportunity summary
    h += '<div class="ecf-section">';
    h += '<div class="ecf-section-label">Opportunity</div>';
    h += '<div class="ecf-section-body">';
    ...
    if (est) {
      h += '<div class="ecf-section">';
      h += '<div class="ecf-section-label">Compensation Model</div>';
      h += '<div class="ecf-section-body">';
    ...
    h += '<div class="ecf-section">';
    h += '<div class="ecf-section-label">Operator Obligations</div>';
    h += '<div class="ecf-section-body">';
    ...
    // 4. Risk / compliance
    h += '<div class="ecf-section">';
    h += '<div class="ecf-section-label">Risk / Compliance</div>';
    h += '<div class="ecf-section-body">';
    ...
    h += '<label class="ecf-accept">';
    h += '<input type="checkbox" id="ecfAcceptCheck">';
    h += '<span class="ecf-accept-text">I understand this is an Economy-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with the applicable workflow.</span>';
    h += '</label>';
  ...
  window.addEventListener('limen:economy-claim-update', function () { setTimeout(injectIntoCards, 100); });

  // ── PUBLIC API ──────────────────────────────────────────────────────

  window.LIMENEconomy.economy.claimFlow = {
    openClaimModal: openClaimModal,
    injectIntoCards: injectIntoCards
  };

  console.log('[EconomyClaimFlow] Loaded — claim acceptance flow ready');
})();
