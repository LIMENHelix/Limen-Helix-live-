/*
 * communication-prediction-error-compressor.js  — ADDITIVE reference implementation
 * ----------------------------------------------------------------------------
 * Concrete form of the PREDICTION_ERROR_COMPRESSION build-target
 * (docs/communication-prediction-error-compression-proposal.md).
 ...
 *
 * CONTRACT:
 *   - Pure/read-only. NEVER reads or writes assets/data/domains/communication.json as a side effect.
...
(function (root) {
  ...
  if (root && !root.CommunicationPredictionErrorCompressor) root.CommunicationPredictionErrorCompressor = API;
