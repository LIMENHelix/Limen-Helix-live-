/**
 * law-claim-ledger.js — Law Domain Claim Ledger (Local Only)
 *
 * Stores claim records in localStorage. Tracks opportunity claims
 * from acceptance through outcome. Law-scoped only.
 *
 * Namespace: window.LIMENLaw.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_LAW_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:law-claim-update')); } catch (e) {}
  ...
  window.LIMENLaw.economy.claims = {
  ...
  console.log('[LawClaimLedger] Loaded \u2014 claim ledger ready');
})();
