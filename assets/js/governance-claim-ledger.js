/**
 * governance-claim-ledger.js — Governance Domain Claim Ledger (Local Only)
 * Namespace: window.LIMENGovernance.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_GOVERNANCE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    all.push(record);
    saveAll(all);
    try { window.dispatchEvent(new CustomEvent('limen:governance-claim-update')); } catch (e) {}
    return record;
  }
  ...
  window.LIMENGovernance.economy.claims = {
  ...
  console.log('[GovernanceClaimLedger] Loaded');
})();
