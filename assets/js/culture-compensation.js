...
(function () {
  ...
  var compensation = {
    ...
    byType: {
      grant: { label: 'Culture Grant Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
      patent: { label: 'Patent Execution', operatorBasePct: 0.08, operatorSuccessPct: 0.12 },
      loan: { label: 'Culture Loan Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
  ...
  window.LIMENCulture.economy.compensation = compensation;
