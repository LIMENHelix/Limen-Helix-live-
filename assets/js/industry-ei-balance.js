/**
 * industry-ei-balance.js — Excitation/Inhibition balance controller for the Industry brain.
 *
 ...
 *
 * Dual export: window.IndustryEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Industry brain state, defensively. Never throws.
  ...
  if (root) root.IndustryEIBalance = API;
