/**
 * defense-claim-ledger.js — Defense Domain Claim Ledger (Local Only)
 * Namespace: window.LIMENDefense.economy.claims
 */
(function () {
  'use strict';
  ...
  function createClaimRecord(opportunity) {
    ...
    all.push(record);
    saveAll(all);
    try { window.dispatchEvent(new CustomEvent('limen:defense-claim-update')); } catch (e) {}
    return record;
  }
  ...
  window.LIMENDefense.economy.claims = {
