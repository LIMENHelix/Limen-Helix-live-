/**
 * communication-ei-balance.js — Excitation/Inhibition balance controller for the Communication brain.
 *
 ...
 *
 * Dual export: window.CommunicationEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Communication brain state, defensively. Never throws.
  ...
  if (root) root.CommunicationEIBalance = API;
