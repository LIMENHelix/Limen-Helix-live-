/*
 * population-prediction-error-compressor.js  — ADDITIVE reference implementation
 * ----------------------------------------------------------------------------
 * Concrete form of the PREDICTION_ERROR_COMPRESSION build-target
 * (docs/population-prediction-error-compression-proposal.md).
 ...
 *
 * CONTRACT:
 *   - Pure/read-only. NEVER reads or writes assets/data/domains/population.json as a side effect.
...
(function (root) {
  ...
  if (root && !root.PopulationPredictionErrorCompressor) root.PopulationPredictionErrorCompressor = API;
