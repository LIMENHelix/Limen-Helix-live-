...
(function () {
  ...
  var STORE_KEY = 'LIMEN_SCIENCE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:science-claim-update')); } catch (e) {}
  ...
  window.LIMENScience.economy.claims = {
