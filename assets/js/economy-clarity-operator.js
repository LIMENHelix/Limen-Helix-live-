      ...
      execBtns[eb].addEventListener('click', function (e) {
        ...
        try {
          ...
          sessionStorage.setItem('limen_exec_context', JSON.stringify({
            ...
            source: 'economy',
            returnTo: '/domain-console?domain=economy&mode=operator'
          }));
        } catch (ex) {}
        var trackName = trackMap[execPath] || 'grant';
        window.location.href = 'economy-workspace.html?track=' + trackName + '&opp=' + encodeURIComponent(execKey) + '&returnTo=' + encodeURIComponent('/domain-console?domain=economy&mode=operator');
      });
    }
