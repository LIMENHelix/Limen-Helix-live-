...
(function () {
  ...
  var PLAYBOOKS = [
  {
    ...
    type:'fund', domains:['culture','population','governance'],
    ...
    action:'Drill into the Culture portal CULTURAL_ERASURE diagnosis. Review treatment nodes for identity restoration, heritage preservation, and cohesion rebuilding. Match to foundation grants and cultural infrastructure.',
    valueRange:'$500K\u2013$10M foundation grants / cultural infrastructure',
    saturation:'low',
    ...
    realWorld:{invest:'Cultural platforms and creative economy companies.',apply:'NEA, NEH, or UNESCO cultural preservation grants.',build:'Build digital heritage archives, cultural mapping, or identity documentation platforms.'},
    ...
    fastPath:['1. Confirm CULTURAL_ERASURE active in console','2. Drill into portal \u2192 review identity and heritage treatments','3. Apply for NEA/NEH grants or invest in cultural preservation infrastructure']
  },
  {
    id:'heritage_destruction', title:'Heritage Destruction Response',
    type:'fund', domains:['culture','defense','governance'],
    ...
    action:'Drill into the Culture portal HERITAGE_DESTRUCTION diagnosis. Review treatment nodes for emergency preservation, restoration, and digital documentation. Match to UNESCO or emergency cultural grants.',
    valueRange:'$1M\u2013$50M emergency preservation grants',
    saturation:'low',
    ...
    realWorld:{invest:'Digital preservation and 3D scanning technology companies.',apply:'UNESCO, Smithsonian, or national cultural heritage emergency grants.',build:'Build 3D heritage documentation, cultural site monitoring, or restoration planning tools.'},
    ...
    fastPath:['1. Confirm HERITAGE_DESTRUCTION active with heritage_loss signals','2. Drill into portal \u2192 review preservation and documentation treatments','3. Apply for UNESCO emergency heritage funds']
  },
  {
    ...
    valueRange:'Advisory and foundation-funded advocacy',
    saturation:'low',
    ...
    steps:['Go to limenhelix.com/domain-console?domain=culture \u2192 check CLARITY','Expand DIAGNOSES \u2192 confirm CENSORSHIP is active','Check cross-domain emissions to law and communication','Click through to portal \u2192 open CENSORSHIP detail','Review treatment nodes for expression protection and narrative diversity','Identify arts freedom organizations and legal defense funds','Assess advocacy, legal, or technology pathway'],
    ...
    realWorld:{invest:'Independent publishing and creative platforms (Substack, Spotify).',apply:'PEN International, Foundation for Individual Rights in Education, or NEA grants.',build:'Build censorship monitoring, alternative distribution, or creative freedom platforms.'},
  ...
  },
  {
    ...
    type:'fund', domains:['culture','religion','population'],
    ...
    action:'Drill into the Culture portal IDENTITY_CRISIS diagnosis. Review treatment nodes for cohesion rebuilding, dialogue facilitation, and identity integration. Match to community development grants.',
    valueRange:'$500K\u2013$5M community development grants',
    saturation:'low',
    ...
    steps:['Go to limenhelix.com/domain-console?domain=culture \u2192 check CLARITY','Expand DIAGNOSES \u2192 confirm IDENTITY_CRISIS is active','Check cross-domain emissions to religion and population','Click through to portal \u2192 open IDENTITY_CRISIS detail','Review treatment nodes for cohesion rebuilding and dialogue facilitation','Identify community organizations and social bridging initiatives','Apply for community development or social cohesion grants'],
    ...
    window:'6 months\u20135 years',
    realWorld:{invest:'Community platforms and social bridging technology.',apply:'Foundation grants for social cohesion and community development.',build:'Build intercultural dialogue, community engagement, or identity integration platforms.'},
    ...
    fastPath:['1. Confirm IDENTITY_CRISIS active with identity_fracture or value_conflict','2. Drill into portal \u2192 review cohesion and dialogue treatments','3. Apply for community development grants']
  },
  {
    ...
    action:'Drill into the Culture portal CREATIVE_STAGNATION diagnosis. Review treatment nodes for creative ecosystem support, audience rebuilding, and institutional revitalization. Match to arts funding or creative economy investments.',
    valueRange:'10\u201325% creative economy returns / arts grants',
    saturation:'medium',
    ...
    realWorld:{invest:'Creative economy: Spotify (SPOT), Etsy (ETSY), content creator platforms.',apply:'NEA, NEH, or state arts council grants.',build:'Build creative ecosystem tools, audience analytics, or arts funding platforms.'},
    ...
    fastPath:['1. Confirm CREATIVE_STAGNATION active with participation_decay signals','2. Drill into portal \u2192 review creative support and audience treatments','3. Invest in creative economy (SPOT, ETSY) or apply for NEA grants']
  },
  {
    ...
    steps:['Go to limenhelix.com/domain-console?domain=culture \u2192 check feed health','Count OFFLINE sources','Identify which cultural dimension is uncovered','Build a data pipeline','Apply to NEH or NSF for cultural data infrastructure grants'],
    ...
    realWorld:{invest:'N/A',apply:'NEH, NSF, or Knight Foundation cultural data grants.',build:'Build cultural analytics integrating social cohesion, participation, and creative ecosystem data.'},
    ...
    fastPath:['1. Check feed health: are Culture sources offline?','2. Identify which cultural dimension is uncovered','3. Build a data pipeline and apply to NEH or NSF']
  }
  ];
