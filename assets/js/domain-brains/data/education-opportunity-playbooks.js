...
(function () {
  ...
  var PLAYBOOKS = [
  {
    ...
    type:'invest', domains:['education','governance','economy'],
    ...
    steps:['Go to limenhelix.com/domain-console?domain=education \u2192 check CLARITY','Expand DIAGNOSES \u2192 confirm FUNDING_CRISIS active','Click through to portal \u2192 open FUNDING_CRISIS detail','Review treatment nodes for funding and infrastructure interventions','Map edtech investment targets (COUR, DUOL, INST) or research institutional capacity models'],
    ...
    realWorld:{invest:'Edtech: Coursera (COUR), Duolingo (DUOL), Instructure (INST).',research:'Research institutional capacity models, resource allocation frameworks, and education funding dynamics.',build:'Build education funding analytics or resource optimization platforms.'},
    ...
    fastPath:['1. Confirm FUNDING_CRISIS active','2. Drill into portal \u2192 review funding and resource treatments','3. Invest in edtech (COUR, DUOL) or research institutional capacity models']
  },
  {
    ...
    realWorld:{invest:'Education workforce: Coursera (COUR), Guild Education (private).',research:'Research teacher pipeline dynamics, retention drivers, and alternative certification models.',build:'Build teacher recruitment or professional development platforms.'},
    ...
    fastPath:['1. Confirm TEACHER_SHORTAGE active','2. Drill into portal \u2192 review recruitment and retention treatments','3. Invest in education workforce platforms or research teacher pipeline models']
  },
  {
    id:'achievement_gap', title:'Achievement Gap Response',
    type:'invest', domains:['education','population','governance'],
    ...
    steps:['Go to limenhelix.com/domain-console?domain=education \u2192 check CLARITY','Expand DIAGNOSES \u2192 confirm ACHIEVEMENT_GAP active','Click through to portal \u2192 open ACHIEVEMENT_GAP detail','Review equity, access, and intervention treatments','Map adaptive learning investment targets or research equity intervention evidence'],
    ...
    window:'1\u20135 years',
    realWorld:{invest:'Adaptive learning platforms: targeted edtech serving underserved markets.',research:'Research equity intervention evidence, Title I program effectiveness, and access gap data.',build:'Build adaptive learning or personalized intervention platforms.'},
    ...
    fastPath:['1. Confirm ACHIEVEMENT_GAP active','2. Drill into portal \u2192 review equity treatments','3. Invest in adaptive learning platforms or research equity intervention evidence']
  },
  {
    ...
    realWorld:{invest:'Credential verification platforms and accreditation analytics.',research:'Research standards erosion patterns, accreditation reform models, and quality assurance frameworks.',build:'Build credential verification or quality monitoring platforms.'},
    ...
    fastPath:['1. Confirm ACCREDITATION_FAILURE active','2. Drill into portal \u2192 review quality treatments','3. Invest in credential verification platforms or research accreditation reform models']
  },
  {
    ...
    window:'6 months\u20135 years',
    realWorld:{invest:'Coursera (COUR), Duolingo (DUOL), Instructure (INST).',research:'Research edtech adoption dynamics, pedagogical innovation models, and digital divide evidence.',build:'Build adaptive learning or AI tutoring platforms.'},
    ...
    fastPath:['1. Confirm TECHNOLOGY_DISRUPTION active','2. Drill into portal \u2192 review adaptive and digital treatments','3. Invest in edtech (COUR, DUOL, INST) or research adoption dynamics']
  },
  {
    ...
    steps:['Check feed health','Count OFFLINE sources','Identify uncovered dimension','Build a data pipeline','Research education data infrastructure models'],
    ...
    realWorld:{invest:'N/A',research:'Research education data infrastructure models, outcome measurement frameworks, and equity monitoring gaps.',build:'Build education outcome tracking.'},
    ...
    fastPath:['1. Check feed health','2. Identify uncovered dimension','3. Build pipeline and research education data infrastructure models']
  }
  ];
