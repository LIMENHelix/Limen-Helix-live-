...
(function () {
  ...
  PopulationBrain.prototype._refreshPopulationActionOutcome = function () {
    if (typeof fetch !== 'function') return null;
    var cycle = this._cycleCount || 0;
    if (this._lastPopulationActionOutcomeCycle && cycle - this._lastPopulationActionOutcomeCycle < 12) return this._populationActionOutcome || null;
    this._lastPopulationActionOutcomeCycle = cycle;
    var self = this;
    try {
  ...
  PopulationBrain.prototype._computePopulationPlasticity = function () {
    ...
    try { this._refreshPopulationActionOutcome(); } catch (e) {}
    ...
    var actionOutcome = this._populationActionOutcome;
