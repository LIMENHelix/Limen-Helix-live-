/**
 * soft-desk.js — shared helpers for the Soft-domain product desks
 * (culture, religion, education). Loaded only by those three pages.
 *
...
(function (root) {
  ...
  root.LIMEN_SOFT_DESK = { qs: qs, esc: esc, money: money, bigUsd: bigUsd, banner: banner, lead: lead };
})(window);
