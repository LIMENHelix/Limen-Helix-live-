 ...
 *
 * Injects a small economics block into each Population opportunity card
 ...
 * Namespace: window.LIMENPopulation.economy.economics
 */
(function () {
  'use strict';
  ...
  window.LIMENPopulation.economy.economics = {
