/**
 * education-claim-flow.js — Education Domain Claim Acceptance Flow
 * Namespace: window.LIMENEducation.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Education Opportunity</div>';
    ...
    h += '<span class="ecf-accept-text">I understand this is an Education-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with FERPA, COPPA, accreditation, and student-data protection rules where applicable.</span></label>';
  ...
  window.addEventListener('limen:education-claim-update', function () { setTimeout(injectIntoCards, 100); });

  window.LIMENEducation.economy.claimFlow = { openClaimModal: openClaimModal, injectIntoCards: injectIntoCards };
  console.log('[EducationClaimFlow] Loaded');
})();
