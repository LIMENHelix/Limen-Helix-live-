/*
 * religion-prediction-error-compressor.js  — ADDITIVE reference implementation
 * ----------------------------------------------------------------------------
 * Concrete form of the PREDICTION_ERROR_COMPRESSION build-target
 * (docs/religion-prediction-error-compression-proposal.md).
 ...
 *
 * CONTRACT:
 *   - Pure/read-only. NEVER reads or writes assets/data/domains/religion.json as a side effect.
...
(function (root) {
  ...
  if (root && !root.ReligionPredictionErrorCompressor) root.ReligionPredictionErrorCompressor = API;
