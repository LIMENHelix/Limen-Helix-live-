/**
 * trade-ei-balance.js — Excitation/Inhibition balance controller for the Trade brain.
 *
 ...
 *
 * Dual export: window.TradeEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Trade brain state, defensively. Never throws.
  ...
  if (root) root.TradeEIBalance = API;
