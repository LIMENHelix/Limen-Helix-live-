/**
 * finance-compensation.js — Finance Domain Compensation Model
 *
 * Defines operator compensation rates by opportunity type.
 * Finance-scoped only. No backend. No payment processing.
 *
 * Namespace: window.LIMENFinance.economy.compensation
 */
(function () {
  'use strict';
  ...
  window.LIMENFinance.economy.compensation = compensation;

  console.log('[FinanceCompensation] Loaded — compensation model ready');
})();
