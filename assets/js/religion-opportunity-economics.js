 ...
 *
 * Injects a small economics block into each Religion opportunity card
 ...
 * Namespace: window.LIMENReligion.economy.economics
 */
(function () {
  'use strict';
  ...
  window.LIMENReligion.economy.economics = {
