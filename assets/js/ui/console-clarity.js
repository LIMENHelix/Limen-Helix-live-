...
(function () {
  ...
  function _injectStyles() {
    ...
    s.textContent = [
      ...
      '.clr-section-title { font-size:0.56rem; letter-spacing:3px; text-transform:uppercase;',
      '  color:rgba(201,169,78,0.65); margin-bottom:11px; font-weight:600; }',
      '.clr-domain-grid { display:grid; grid-template-columns:1fr 1fr; gap:9px 12px; align-items:start; }',
      '@media(max-width:700px) { .clr-domain-grid { grid-template-columns:1fr; } }',
      '.clr-domain-grid > div { border:1px solid rgba(201,169,78,0.07); border-radius:6px; padding:9px 11px 10px; background:linear-gradient(180deg,rgba(255,255,255,0.013),rgba(0,0,0,0.10)); transition:border-color 0.2s; }',
      '.clr-domain-grid > div:hover { border-color:rgba(201,169,78,0.18); }',
      '.clr-domain-row { display:flex; align-items:center; gap:9px; padding:2px 0; cursor:pointer; }',
      '.clr-domain-label { min-width:96px; font-size:0.62rem; letter-spacing:1px; color:#e2ddd0; text-transform:uppercase; font-weight:600; }',
      '.clr-domain-track { flex:1; height:5px; background:rgba(255,255,255,0.06); border-radius:3px; overflow:hidden; min-width:50px; }',
      '.clr-domain-fill { height:100%; border-radius:3px; transition:width 0.5s ease; }',
      '.clr-domain-val { width:44px; font-size:0.64rem; color:#e2ddd0; text-align:right; font-weight:600; font-variant-numeric:tabular-nums; }',
      ...
      '.clr-dh-tile-badge { display:inline-block; font-size:0.34rem; letter-spacing:0.8px;',
      '  text-transform:uppercase; margin:0 0 6px; font-weight:500; opacity:0.72;',
      ...
      '.clr-dh-sect-label { font-size:0.46rem; color:rgba(201,169,78,0.5);',
      '  letter-spacing:1px; margin-top:6px; text-transform:uppercase; }',
      '.clr-dh-sect-row { font-size:0.48rem; color:rgba(200,195,184,0.6);',
      '  padding-left:6px; line-height:1.6; }',

      /* Tabs */
      '.clr-tab-bar { display:flex; gap:0; border-bottom:1px solid rgba(201,169,78,0.1);',
      '  margin-bottom:0; overflow-x:auto; }',
      '.clr-tab { padding:9px 16px; font-size:0.56rem; letter-spacing:1.5px; text-transform:uppercase;',
      '  cursor:pointer; color:#8a8478; border:none; background:none; border-bottom:2px solid transparent;',
      '  font-family:inherit; white-space:nowrap; transition:color 0.2s,border-color 0.2s; }',
