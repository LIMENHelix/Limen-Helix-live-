      ...
      for (var ti = 0; ti < expectedTypes.length; ti++) {
        ...
        if (!alreadyMapped) {
          if (expected.confidence >= 0.85) {
            consequence = 'If approved: this business type becomes eligible for opportunity generation and operator queue inclusion for Law. It will appear as a valid target in grants, investments, and patent searches tied to ' + dir.label + '.';
