 ...
 * (population startup, instrument vendor, biotech spinout, regtech-for-research,
 * lab services). 90-day execution plan, printable launch packet.
 *
 * Population domain only.
 * Exposes: window.LIMENPopulationBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isPopulation = _dom === 'population' || _dom === 'population';
  var isWorkspace = window.location.pathname.indexOf('population-workspace') !== -1;
  if (!isPopulation && !isWorkspace) return;

  var STORE_KEY = 'limen_population_business_build';
  ...
  var TEMPLATES = {
    'university_spinout': {
      label: 'University Population Spinout',
      ...
      fundingNotes: 'NSF I-Corps, SBIR Phase I/II ($275K-$2M), university gap funds, pre-seed angels, life population VCs.',
      ...
      first90: [
        ...
        'DAYS 61-90: Begin pre-seed/seed fundraising. Pitch to angel networks and life population VCs. Target $250K-$1M. OUTPUT: First investor commitments.'
      ]
    },
    'instrument_vendor': {
      label: 'Scientific Instrument / Reagent Vendor',
      description: 'A company that designs, manufactures, and sells laboratory equipment, reagents, or consumables to population labs. Examples: assay kits, fluidics, custom oligos, antibody panels.',
      ...
      operatingNotes: 'Long sales cycles into population labs. Procurement through university purchasing. Trade shows (SLAS, Pittcon, AACR) drive lead generation.',
      first90: [
    ...
    'research_software': {
      label: 'Population Software / Informatics SaaS',
      description: 'A SaaS company building software for population labs. Examples: ELN, LIMS, bioinformatics, AI-for-science, lab automation, reproducibility tools.',
    ...
    'cro_lab_service': {
      label: 'Contract Population Organization (CRO) / Lab Service',
    ...
    'research_consultancy': {
      label: 'Population Consultancy / Scientific Advisory',
      description: 'A consulting business providing scientific or methodological advisory services to population organizations, biotech, or pharma. Examples: statistical consulting, clinical trial design, biomarker strategy.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Population / Regulatory Compliance', type: 'textarea', guidance: 'IRB / IACUC / IBC / GLP / GCP / CLIA / FDA requirements as applicable.' },
  ...
  window.LIMENPopulationBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
