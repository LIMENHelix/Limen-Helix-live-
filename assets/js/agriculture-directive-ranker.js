/**
 * agriculture-directive-ranker.js — Score and rank extracted directive candidates
 *
 ...
 * Exposes: window.LIMENAgricultureDirectiveRanker
 */
(function () {
  'use strict';
  ...
  var MECHANISMS = {
    input_cost_spike:     { label: 'Input Cost Spike',       signals: ['input cost', 'fertilizer price', 'seed cost', 'chemical cost', 'fuel cost', 'feed cost', 'input expense', 'cost of production', 'operating cost', 'expense spike', 'cost increase', 'price hike'] },
    margin_compression:   { label: 'Margin Compression',     signals: ['margin', 'profit', 'breakeven', 'cost squeeze', 'compress', 'thin margin', 'negative margin', 'loss', 'revenue gap', 'cash flow', 'working capital', 'debt service'] },
    logistics_constraint: { label: 'Logistics Constraint',   signals: ['transport', 'shipping', 'rail', 'truck', 'barge', 'port', 'terminal', 'bottleneck', 'congestion', 'capacity', 'logistics', 'cold chain', 'freight', 'throughput', 'routing'] },
    supply_disruption:    { label: 'Supply Disruption',      signals: ['supply', 'shortage', 'disruption', 'scarcity', 'outage', 'embargo', 'cutoff', 'curtail', 'stockpile', 'reserves', 'seed supply', 'fertilizer supply', 'feed supply'] },
    infrastructure_stress:{ label: 'Infrastructure Stress',  signals: ['infrastructure', 'irrigation', 'storage facility', 'silo', 'grain elevator', 'equipment', 'machinery', 'tractor', 'combine', 'processing plant', 'cold storage', 'warehouse', 'hardening', 'resilience'] },
    production_impact:    { label: 'Production Impact',      signals: ['production', 'yield', 'harvest', 'planting', 'crop', 'livestock', 'output', 'acreage', 'cultivation', 'growing season', 'germination', 'maturation', 'calving', 'lambing'] },
    policy_response:      { label: 'Policy Response',        signals: ['regulatory', 'regulation', 'policy', 'mandate', 'compliance', 'subsidy', 'incentive', 'tariff', 'sanction', 'farm bill', 'crop insurance', 'usda', 'epa', 'conservation'] },
    price_dislocation:    { label: 'Price Dislocation',      signals: ['price', 'pricing', 'repric', 'cost', 'premium', 'spike', 'volatil', 'futures', 'spot', 'forward', 'spread', 'basis', 'commodity price', 'market price', 'farmgate'] },
    contract_mispricing:  { label: 'Contract Mispricing',    signals: ['contract', 'bilateral', 'counterparty', 'hedge', 'renegotiat', 'settlement', 'credit', 'default', 'exposure', 'procurement', 'offtake', 'forward contract', 'basis contract'] },
    market_structure:     { label: 'Market Structure',       signals: ['trading', 'commodity', 'exchange', 'clearing', 'settlement', 'market design', 'auction', 'merit order', 'capacity market', 'ancillary', 'market access', 'buyer concentration'] },
    inventory_imbalance:  { label: 'Inventory Imbalance',    signals: ['inventory', 'storage', 'drawdown', 'build', 'reserve', 'buffer', 'stockpile', 'days of supply', 'bin', 'silo', 'carry', 'carryover', 'surplus', 'glut', 'shortage'] },
    debt_service:         { label: 'Debt Service',           signals: ['debt', 'loan', 'credit', 'interest', 'mortgage', 'operating loan', 'line of credit', 'refinance', 'default', 'bankruptcy', 'leverage', 'debt-to-asset', 'collateral'] }
  };

  // Which mechanisms are VALID for each diagnosis
  var DX_VALID_MECHANISMS = {
    'CASH_FLOW_CRISIS':        ['margin_compression', 'input_cost_spike', 'debt_service', 'price_dislocation', 'contract_mispricing', 'inventory_imbalance'],
    'SUPPLY_CHAIN_BREAKDOWN':  ['supply_disruption', 'logistics_constraint', 'infrastructure_stress', 'inventory_imbalance', 'input_cost_spike', 'contract_mispricing'],
    'DROUGHT':                 ['production_impact', 'supply_disruption', 'price_dislocation', 'infrastructure_stress', 'inventory_imbalance', 'policy_response'],
    'MARKET_COLLAPSE':         ['price_dislocation', 'margin_compression', 'market_structure', 'contract_mispricing', 'inventory_imbalance', 'debt_service'],
    'EQUIPMENT_FAILURE':       ['infrastructure_stress', 'production_impact', 'supply_disruption', 'margin_compression', 'logistics_constraint'],
    'PEST_OUTBREAK':           ['production_impact', 'supply_disruption', 'input_cost_spike', 'price_dislocation', 'policy_response', 'inventory_imbalance']
  };
  ...
  function rank(directives) {
    ...
    console.log('[AgriRanker] Ranked ' + directives.length + '. Top: ' +
  ...
  window.LIMENAgricultureDirectiveRanker = { rank: rank };
})();
