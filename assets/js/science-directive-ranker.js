/**
 * science-directive-ranker.js — Score and rank extracted Science directive candidates
 *
 ...
 * Exposes: window.LIMENScienceDirectiveRanker
 */
(function () {
  'use strict';
  ...
  // ══════════════════════════════════════════════════════════════════════
  // SCIENCE-NATIVE MECHANISM CLASSIFICATION
  // ══════════════════════════════════════════════════════════════════════

  var MECHANISMS = {
    replication_failure: { label: 'Replication Failure',     signals: ['replication', 'reproduce', 'replicate', 'reproducibility', 'methodology', 'protocol', 'preregistration', 'p-hacking', 'p hacking', 'underpowered', 'sample size'] },
    data_integrity:      { label: 'Data Integrity',          signals: ['data integrity', 'fraud', 'falsification', 'fabrication', 'misconduct', 'retraction', 'image manipulation', 'duplicate publication', 'plagiarism', 'authorship'] },
    funding_decline:     { label: 'Funding Decline',         signals: ['funding', 'grant', 'budget', 'NSF', 'NIH', 'DARPA', 'foundation', 'endowment', 'sequestration', 'appropriation', 'indirect cost'] },
    publication_bias:    { label: 'Publication Bias',        signals: ['publication bias', 'file drawer', 'negative result', 'selective reporting', 'cherry pick', 'reporting gap', 'meta-analysis', 'preprint'] },
    paradigm_shift:      { label: 'Paradigm Shift',          signals: ['paradigm', 'breakthrough', 'discovery', 'theoretical', 'consensus', 'kuhn', 'revolution', 'foundational', 'reframe', 'novel framework'] },
    workforce_loss:      { label: 'Workforce Loss',          signals: ['brain drain', 'researcher exodus', 'talent loss', 'postdoc', 'tenure', 'attrition', 'retention', 'pipeline', 'workforce'] },
    peer_review_strain:  { label: 'Peer Review Strain',      signals: ['peer review', 'reviewer', 'editor', 'desk reject', 'review backlog', 'open review', 'post-publication', 'preprint review'] },
    methodology_gap:     { label: 'Methodology Gap',         signals: ['method', 'protocol', 'standard', 'instrument', 'calibration', 'measurement', 'statistical method', 'experimental design', 'control group'] },
    open_science:        { label: 'Open Science',            signals: ['open access', 'open data', 'open source', 'FAIR data', 'data sharing', 'preprint', 'open peer review', 'open infrastructure', 'commons'] },
    translation_gap:     { label: 'Translation Gap',         signals: ['translation', 'tech transfer', 'commercialization', 'bench-to-bedside', 'first-in-human', 'pilot study', 'scale-up', 'TRL', 'valley of death', 'spinout'] }
  };

  var DX_VALID_MECHANISMS = {
    'REPLICATION_CRISIS':  ['replication_failure', 'methodology_gap', 'data_integrity', 'open_science'],
    'FUNDING_COLLAPSE':    ['funding_decline', 'workforce_loss', 'translation_gap'],
    'DATA_FRAUD':          ['data_integrity', 'peer_review_strain', 'publication_bias'],
    'PARADIGM_CONFLICT':   ['paradigm_shift', 'peer_review_strain', 'publication_bias', 'open_science'],
    'BRAIN_DRAIN':         ['workforce_loss', 'funding_decline'],
    'PUBLICATION_BIAS':    ['publication_bias', 'peer_review_strain', 'data_integrity', 'open_science']
  };
  ...
  window.LIMENScienceDirectiveRanker = { rank: rank };
})();
