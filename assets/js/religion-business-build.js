 ...
 * (religion startup, instrument vendor, biotech spinout, regtech-for-research,
 * lab services). 90-day execution plan, printable launch packet.
 *
 * Religion domain only.
 * Exposes: window.LIMENReligionBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isReligion = _dom === 'religion' || _dom === 'religion';
  var isWorkspace = window.location.pathname.indexOf('religion-workspace') !== -1;
  if (!isReligion && !isWorkspace) return;

  var STORE_KEY = 'limen_religion_business_build';
  ...
  var TEMPLATES = {
    'university_spinout': {
      label: 'University Religion Spinout',
      ...
      fundingNotes: 'NSF I-Corps, SBIR Phase I/II ($275K-$2M), university gap funds, pre-seed angels, life religion VCs.',
      ...
      first90: [
        ...
        'DAYS 61-90: Begin pre-seed/seed fundraising. Pitch to angel networks and life religion VCs. Target $250K-$1M. OUTPUT: First investor commitments.'
      ]
    },
    'instrument_vendor': {
      label: 'Scientific Instrument / Reagent Vendor',
      description: 'A company that designs, manufactures, and sells laboratory equipment, reagents, or consumables to religion labs. Examples: assay kits, fluidics, custom oligos, antibody panels.',
      ...
      operatingNotes: 'Long sales cycles into religion labs. Procurement through university purchasing. Trade shows (SLAS, Pittcon, AACR) drive lead generation.',
      first90: [
    ...
    'research_software': {
      label: 'Religion Software / Informatics SaaS',
      description: 'A SaaS company building software for religion labs. Examples: ELN, LIMS, bioinformatics, AI-for-science, lab automation, reproducibility tools.',
    ...
    'cro_lab_service': {
      label: 'Contract Religion Organization (CRO) / Lab Service',
    ...
    'research_consultancy': {
      label: 'Religion Consultancy / Scientific Advisory',
      description: 'A consulting business providing scientific or methodological advisory services to religion organizations, biotech, or pharma. Examples: statistical consulting, clinical trial design, biomarker strategy.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Religion / Regulatory Compliance', type: 'textarea', guidance: 'IRB / IACUC / IBC / GLP / GCP / CLIA / FDA requirements as applicable.' },
  ...
  window.LIMENReligionBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
