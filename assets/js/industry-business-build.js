 ...
 * (industry startup, instrument vendor, biotech spinout, regtech-for-research,
 * lab services). 90-day execution plan, printable launch packet.
 *
 * Industry domain only.
 * Exposes: window.LIMENIndustryBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isIndustry = _dom === 'industry' || _dom === 'industry';
  var isWorkspace = window.location.pathname.indexOf('industry-workspace') !== -1;
  if (!isIndustry && !isWorkspace) return;

  var STORE_KEY = 'limen_industry_business_build';
  ...
  var TEMPLATES = {
    'university_spinout': {
      label: 'University Industry Spinout',
      ...
      fundingNotes: 'NSF I-Corps, SBIR Phase I/II ($275K-$2M), university gap funds, pre-seed angels, life industry VCs.',
      ...
      first90: [
        ...
        'DAYS 61-90: Begin pre-seed/seed fundraising. Pitch to angel networks and life industry VCs. Target $250K-$1M. OUTPUT: First investor commitments.'
      ]
    },
    'instrument_vendor': {
      label: 'Scientific Instrument / Reagent Vendor',
      description: 'A company that designs, manufactures, and sells laboratory equipment, reagents, or consumables to industry labs. Examples: assay kits, fluidics, custom oligos, antibody panels.',
      ...
      operatingNotes: 'Long sales cycles into industry labs. Procurement through university purchasing. Trade shows (SLAS, Pittcon, AACR) drive lead generation.',
      first90: [
    ...
    'research_software': {
      label: 'Industry Software / Informatics SaaS',
      description: 'A SaaS company building software for industry labs. Examples: ELN, LIMS, bioinformatics, AI-for-science, lab automation, reproducibility tools.',
    ...
    'cro_lab_service': {
      label: 'Contract Industry Organization (CRO) / Lab Service',
    ...
    'research_consultancy': {
      label: 'Industry Consultancy / Scientific Advisory',
      description: 'A consulting business providing scientific or methodological advisory services to industry organizations, biotech, or pharma. Examples: statistical consulting, clinical trial design, biomarker strategy.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Industry / Regulatory Compliance', type: 'textarea', guidance: 'IRB / IACUC / IBC / GLP / GCP / CLIA / FDA requirements as applicable.' },
  ...
  window.LIMENIndustryBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
