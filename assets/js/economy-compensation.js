/**
 * economy-compensation.js — Economy Domain Compensation Model
 *
 * Defines operator compensation rates by opportunity type.
 * Economy-scoped only. No backend. No payment processing.
 *
 * Namespace: window.LIMENEconomy.economy.compensation
 */
(function () {
  'use strict';
  ...
  var compensation = {
    ...
    // Lanes: investment + research ONLY (grant/patent/loan purged 2026-06-21; relaned GRANT->invest, PATENT->research)
    byType: {
      investment: {
  ...
  window.LIMENEconomy.economy.compensation = compensation;

  console.log('[EconomyCompensation] Loaded — compensation model ready');
})();
