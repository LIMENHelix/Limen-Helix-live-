/**
 * technology-ei-balance.js — Excitation/Inhibition balance controller for the Technology brain.
 *
 ...
 *
 * Dual export: window.TechnologyEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Technology brain state, defensively. Never throws.
  ...
  if (root) root.TechnologyEIBalance = API;
