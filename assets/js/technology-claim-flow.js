/**
 * technology-claim-flow.js — Technology Domain Claim Acceptance Flow
 * Namespace: window.LIMENTechnology.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Technology Opportunity</div>';
    ...
    h += '<span class="ecf-accept-text">I understand this is an Technology-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with FERPA, COPPA, accreditation, and student-data protection rules where applicable.</span></label>';
  ...
  window.addEventListener('limen:technology-claim-update', function () { setTimeout(injectIntoCards, 100); });

  window.LIMENTechnology.economy.claimFlow = { openClaimModal: openClaimModal, injectIntoCards: injectIntoCards };
  console.log('[TechnologyClaimFlow] Loaded');
})();
