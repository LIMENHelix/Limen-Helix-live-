...
(function () {
  ...
  var STORE_KEY = 'LIMEN_CULTURE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:culture-claim-update')); } catch (e) {}
  ...
  window.LIMENCulture.economy.claims = {
