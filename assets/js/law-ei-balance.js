/**
 * law-ei-balance.js — Excitation/Inhibition balance controller for the Law brain.
 *
 ...
 *
 * Dual export: window.LawEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Law brain state, defensively. Never throws.
