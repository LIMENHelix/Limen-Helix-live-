/**
 * trade-claim-ledger.js — Trade Domain Claim Ledger (Local Only)
 *
 * Stores claim records in localStorage. Tracks opportunity claims
 * from acceptance through outcome. Trade-scoped only.
 *
 * Namespace: window.LIMENTrade.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_TRADE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:trade-claim-update')); } catch (e) {}
  ...
  window.LIMENTrade.economy.claims = {
  ...
  console.log('[TradeClaimLedger] Loaded — claim ledger ready');
})();
