/**
 * environment-compensation.js — Environment Domain Compensation Model
 *
 * Defines operator compensation rates by opportunity type for Science.
 * Science-scoped only. No backend. No payment processing.
 *
 * Namespace: window.LIMENEnvironment.economy.compensation
 */
(function () {
  'use strict';
  ...
  window.LIMENEnvironment.economy.compensation = compensation;
