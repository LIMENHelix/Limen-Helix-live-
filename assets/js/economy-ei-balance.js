/**
 * economy-ei-balance.js — Excitation/Inhibition balance controller for the Economy brain.
 *
 ...
 *
 * Dual export: window.EconomyEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Economy brain state, defensively. Never throws.
  ...
  if (root) root.EconomyEIBalance = API;
