/**
 * defense-ei-balance.js — Excitation/Inhibition balance controller for the Defense brain.
 *
 ...
 *
 * Dual export: window.DefenseEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Defense brain state, defensively. Never throws.
  ...
  if (root) root.DefenseEIBalance = API;
