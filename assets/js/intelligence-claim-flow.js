/**
 * intelligence-claim-flow.js — Intelligence Domain Claim Acceptance Flow
 * Namespace: window.LIMENIntelligence.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Intelligence Opportunity</div>';
    ...
    h += '<span class="ecf-accept-text">I understand this is an Intelligence-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with FERPA, COPPA, accreditation, and student-data protection rules where applicable.</span></label>';
  ...
  window.addEventListener('limen:intelligence-claim-update', function () { setTimeout(injectIntoCards, 100); });

  window.LIMENIntelligence.economy.claimFlow = { openClaimModal: openClaimModal, injectIntoCards: injectIntoCards };
