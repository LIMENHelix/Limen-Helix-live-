/**
 * communication-claim-flow.js — Communication Domain Claim Acceptance Flow
 * Namespace: window.LIMENCommunication.economy.claimFlow
 */
(function () {
  'use strict';
  ...
  function openClaimModal(opportunity) {
    ...
    h += '<div class="ecf-title">Claim Communication Opportunity</div>';
    ...
    h += '<span class="ecf-accept-text">I understand this is an Communication-domain execution claim, I am responsible for truthful submission, documented progress, and compliance with FERPA, COPPA, accreditation, and student-data protection rules where applicable.</span></label>';
  ...
  window.addEventListener('limen:communication-claim-update', function () { setTimeout(injectIntoCards, 100); });

  window.LIMENCommunication.economy.claimFlow = { openClaimModal: openClaimModal, injectIntoCards: injectIntoCards };
  console.log('[CommunicationClaimFlow] Loaded');
})();
