/**
 * intelligence-ei-balance.js — Excitation/Inhibition balance controller for the Intelligence brain.
 *
 ...
 *
 * Dual export: window.IntelligenceEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Intelligence brain state, defensively. Never throws.
  ...
  if (root) root.IntelligenceEIBalance = API;
