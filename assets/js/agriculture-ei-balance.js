/**
 * agriculture-ei-balance.js — Excitation/Inhibition balance controller for the Agriculture brain.
 *
 ...
 *
 * Dual export: window.AgricultureEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Agriculture brain state, defensively. Never throws.
  ...
  if (root) root.AgricultureEIBalance = API;
