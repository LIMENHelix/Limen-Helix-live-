/**
 * environment-ei-balance.js — Excitation/Inhibition balance controller for the Environment brain.
 *
 ...
 *
 * Dual export: window.EnvironmentEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Environment brain state, defensively. Never throws.
  ...
  if (root) root.EnvironmentEIBalance = API;
