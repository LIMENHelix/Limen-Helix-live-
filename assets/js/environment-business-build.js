 ...
 * (environment startup, instrument vendor, biotech spinout, regtech-for-research,
 * lab services). 90-day execution plan, printable launch packet.
 *
 * Environment domain only.
 * Exposes: window.LIMENEnvironmentBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isEnvironment = _dom === 'environment' || _dom === 'environment';
  var isWorkspace = window.location.pathname.indexOf('environment-workspace') !== -1;
  if (!isEnvironment && !isWorkspace) return;

  var STORE_KEY = 'limen_environment_business_build';
  ...
  var TEMPLATES = {
    'university_spinout': {
      label: 'University Environment Spinout',
      ...
      fundingNotes: 'NSF I-Corps, SBIR Phase I/II ($275K-$2M), university gap funds, pre-seed angels, life environment VCs.',
      ...
      first90: [
        ...
        'DAYS 61-90: Begin pre-seed/seed fundraising. Pitch to angel networks and life environment VCs. Target $250K-$1M. OUTPUT: First investor commitments.'
      ]
    },
    'instrument_vendor': {
      label: 'Scientific Instrument / Reagent Vendor',
      description: 'A company that designs, manufactures, and sells laboratory equipment, reagents, or consumables to environment labs. Examples: assay kits, fluidics, custom oligos, antibody panels.',
      ...
      operatingNotes: 'Long sales cycles into environment labs. Procurement through university purchasing. Trade shows (SLAS, Pittcon, AACR) drive lead generation.',
      first90: [
    ...
    'research_software': {
      label: 'Environment Software / Informatics SaaS',
      description: 'A SaaS company building software for environment labs. Examples: ELN, LIMS, bioinformatics, AI-for-science, lab automation, reproducibility tools.',
    ...
    'cro_lab_service': {
      label: 'Contract Environment Organization (CRO) / Lab Service',
    ...
    'research_consultancy': {
      label: 'Environment Consultancy / Scientific Advisory',
      description: 'A consulting business providing scientific or methodological advisory services to environment organizations, biotech, or pharma. Examples: statistical consulting, clinical trial design, biomarker strategy.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Environment / Regulatory Compliance', type: 'textarea', guidance: 'IRB / IACUC / IBC / GLP / GCP / CLIA / FDA requirements as applicable.' },
  ...
  window.LIMENEnvironmentBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
