/**
 * finance-ei-balance.js — Excitation/Inhibition balance controller for the Finance brain.
 *
 ...
 *
 * Dual export: window.FinanceEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Finance brain state, defensively. Never throws.
  ...
  if (root) root.FinanceEIBalance = API;
