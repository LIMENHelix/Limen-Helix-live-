/**
 * intelligence-claim-ledger.js — Intelligence Domain Claim Ledger (Local Only)
 * Namespace: window.LIMENIntelligence.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_DEFENSE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    all.push(record);
    saveAll(all);
    try { window.dispatchEvent(new CustomEvent('limen:intelligence-claim-update')); } catch (e) {}
    return record;
  }
  ...
  window.LIMENIntelligence.economy.claims = {
  ...
  console.log('[DefenseClaimLedger] Loaded');
})();
