/**
 * population-ei-balance.js — Excitation/Inhibition balance controller for the Population brain.
 *
 ...
 *
 * Dual export: window.PopulationEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Population brain state, defensively. Never throws.
  ...
  if (root) root.PopulationEIBalance = API;
