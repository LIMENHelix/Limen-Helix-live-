...
(function () {
  ...
  var DOMAIN_ACTIONS = {
    ...
    law: [
      { label: 'Monitor case-backlog and judicial-throughput signals (Administrative Office of US Courts caseload statistics, BJS court-processing data, civil/criminal filing-to-disposition lag, pretrial-detention duration) across court-management and legal-services operators (TYL court-management throughput, RELX/TRI litigation-docket volume)', type: 'monitoring', minStress: 0.3 },
      { label: 'Explore access-to-justice innovation and dispute-resolution modernization (legal-aid funding design, online dispute resolution, court e-filing adoption, pro-bono capacity, regulatory-sandbox alternative legal services across RELX LexisNexis and TRI Thomson Reuters/Westlaw legal-data platform adoption)', type: 'discovery', minStress: 0.4 },
      { label: 'Analyze regulatory-enforcement intensity and compliance-burden exposure (Federal Register rulemaking volume, DOJ/SEC/FTC enforcement-action trend, GAO findings, sector-specific litigation frequency across VERX tax-compliance and CSGP commercial-real-estate-litigation throughput)', type: 'analysis', minStress: 0.5 },
      { label: 'Investigate rule-of-law erosion and judicial-independence strain (World Justice Project Rule of Law Index, V-Dem judicial-constraints scores, ABA judicial-vacancy tracking, contract-enforceability decline, due-process backsliding)', type: 'analysis', minStress: 0.6 },
      { label: 'Investigate constitutional-challenge load and appellate strain (SCOTUS docket and cert-petition rejection rate, opinion-release delays, high-profile case-timeline slippage, circuit-split accumulation) against legal-research and docket-analytics platforms (RELX, TRI case-law throughput)', type: 'analysis', minStress: 0.6 },
      { label: 'Analyze criminal-justice enforcement gaps and adjudication coherence (BJS prosecution-completion and conviction rates, sentencing-disparity dispersion, cold-case inventory, DOJ charging-trend) for due-process and public-safety exposure', type: 'analysis', minStress: 0.6 },
      { label: 'Regulate legal-system-crisis containment and access-to-justice restoration (court-backlog emergency triage, legal-aid surge funding, enforcement-priority rebalancing, constitutional-crisis response, e-filing and court-management capacity surge — TYL throughput failure points)', type: 'regulation', minStress: 0.7 }
    ],
    religion: [
