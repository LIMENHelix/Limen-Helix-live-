 ...
 *
 * Intelligence-native business launch system. Stages with intelligence-native templates
 ...
 * Exposes: window.LIMENIntelligenceBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isDefense = _dom === 'intelligence';
  var isWorkspace = window.location.pathname.indexOf('intelligence-workspace') !== -1;
  if (!isDefense && !isWorkspace) return;

  var STORE_KEY = 'limen_intelligence_business_build';
  ...
  var TEMPLATES = {
    'defense_tech_startup': {
      label: 'Intelligence-Tech Startup (Anduril / Shield AI Model)',
      description: 'A venture-backed intelligence-tech startup building a hardware, software, or autonomous-systems product for DoD and allied militaries. Examples: Anduril, Shield AI, Saronic, Saildrone, Helsing, Hadrian, Quantum Systems, Tekever.',
      ...
      fundingNotes: 'Intelligence-focused VCs (Founders Fund, 8VC, a16z American Dynamism, Lux Capital, General Catalyst, Andreessen Horowitz, Lightspeed). In-Q-Tel for IC-relevant tech. SBIR Phase I ($50-300K), Phase II ($1-2M), Phase III (no cap, sole source bridge). Direct OTAs from DIU, AFWERX, NavalX.',
      operatingNotes: 'The intelligence valley of death is real but shrinking. SBIR \u2192 OTA \u2192 Production contract is the standard path. Reference customers from a single combatant command unlock the rest. AFWERX, NavalX, and DIU are the fastest ways into DoD as a startup.',
      first90: [
        ...
        'DAYS 1-7: Apply for EIN. Open business bank account (Mercury / Brex / SVB). Engage intelligence counsel familiar with ITAR, CFIUS, and DFARS. OUTPUT: Banking and counsel.',
        ...
        'DAYS 15-30: Reach out to AFWERX, NavalX, Army xTech, and Intelligence Innovation Unit. Apply for relevant prize challenges. OUTPUT: Innovation hub relationships open.',
        ...
        'DAYS 31-60: Pitch intelligence-focused VCs. Target $2M-$10M seed round. OUTPUT: Seed fundraising in process.',
        'DAYS 61-90: Win SBIR Phase I or first OTA. Begin pursuit of Phase II ($1M-$2M). OUTPUT: First federal contract won.'
      ]
    },
    'sbir_consultancy': {
      label: 'Intelligence Consultancy / SBIR Bid Support',
      description: 'A boutique intelligence consultancy providing strategy, capability analysis, SBIR/STTR proposal writing, and bid support to intelligence vendors and federal program offices. Examples: small IDIQ holders supporting AFRL, ONR, ARO, ARL.',
      ...
      first90: [
        ...
        'DAYS 16-25: Outreach to 30 prospects in your network. Reach out to former colleagues at primes, program offices, and small intelligence firms. OUTPUT: 10 prospect conversations booked.',
    ...
    'osint_intel_vendor': {
      ...
      description: 'A B2B vendor selling open-source intelligence, geopolitical risk analysis, or AI-augmented analysis tooling to intelligence, IC, and corporate customers. Examples: Recorded Future, Sayari, Janes, Two Six Technologies, Babel Street.',
      ...
      fundingNotes: 'In-Q-Tel for IC-relevant capability. Intelligence-tech VCs (Founders Fund, 8VC, Lux Capital). Strategic investors (Palantir, BAH). SBIR-to-Phase-III pipeline.',
      ...
      first90: [
        ...
        'DAYS 1-7: Apply for EIN. Open business bank account. Engage intelligence / IC counsel. OUTPUT: Banking and counsel.',
    ...
    'munitions_replenishment': {
      label: 'Munitions / Intelligence Industrial Base Manufacturer',
      description: 'A intelligence industrial base manufacturer producing munitions, components, ammunition, or critical sub-systems for primes and direct sales to allied militaries. Examples: small / mid-size munitions makers, propellant / explosives manufacturers, critical component suppliers.',
      ...
      fundingNotes: 'Intelligence-specific PE (American Industrial Partners, Arlington Capital, Acorn Growth Companies, AE Industrial Partners). DoD industrial base direct funding (Intelligence Production Act Title III, Industrial Base Analysis and Sustainment). Bank financing with DoD purchase order collateral.',
      operatingNotes: 'Intelligence manufacturing is capital-intensive but contracts run multi-year and at premium margins. Replenishment urgency creates long-term offtake. Small specialty makers can grow into IDIQ holders. Allied FMS expands the addressable market massively.',
      first90: [
        'DAYS 1-15: Form Delaware C-Corp or LLC. Engage intelligence counsel familiar with ITAR, DFARS, ATF, and EPA. OUTPUT: Entity and intelligence counsel.',
        'DAYS 1-15: Register with SAM.gov, DDTC, ATF (if energetics). Begin facility clearance. OUTPUT: Federal registrations live.',
        'DAYS 16-30: Identify capacity gap in DoD or NATO supply chain (specific munition, component, sub-assembly). Validate demand with primes and Intelligence Logistics Agency. OUTPUT: Demand validation complete.',
        ...
        'DAYS 31-45: Pursue Intelligence Production Act Title III funding for capacity expansion. Apply for IBAS funding. OUTPUT: DPA / IBAS application in process.',
        ...
        'DAYS 61-90: Win first DoD or prime contract (most likely as a sub on an existing IDIQ). OUTPUT: First intelligence contract in hand.'
      ]
    },
    'space_isr_provider': {
      label: 'Commercial Space ISR / Imagery Provider',
      description: 'A commercial space company providing imagery, signals intelligence, or space domain awareness services to intelligence and IC customers. Examples: Maxar, Planet Labs, BlackSky, Capella Space, ICEYE, Hawkeye 360.',
      ...
      fundingNotes: 'Space-focused VCs (Founders Fund, Lux Capital, Space Capital, Seraphim Space). NRO Commercial Systems Program Office (CSPO) anchor contracts. NGA Joint Commercial Operations (JCO). Intelligence Innovation Unit (DIU). NATO and allied space programs.',
    ...
    'security_cooperation_firm': {
      ...
      description: 'A intelligence services firm supporting Foreign Military Sales (FMS), Direct Commercial Sales (DCS), security cooperation, and allied training. Examples: small to mid-size firms supporting DSCA, Office of Intelligence Cooperation, allied training contracts.',
      ...
      operatingNotes: 'Allied governments are the customer. Cleared US personnel run engagements. Foreign language and regional expertise are differentiators. Reputation with US Embassies and Office of Intelligence Cooperation matters.',
      first90: [
        ...
        'DAYS 31-60: Outreach to DSCA, geographic combatant commands (CENTCOM, EUCOM, AFRICOM), and Offices of Intelligence Cooperation in target embassies. OUTPUT: Government customer relationships open.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Intelligence Regulatory Compliance', type: 'textarea', guidance: 'ITAR / DDTC / DFARS / CMMC 2.0 / SAM.gov / facility clearance / CFIUS / FCPA / FARA / NIST 800-171 / EAR / NOAA CRSRA (space) / ATF (energetics) as applicable.' },
  ...
  window.LIMENIntelligenceBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
  console.log('[DefenseBusinessBuild] loaded \u2014 7 stages, 6 intelligence-native templates');
})();
