/**
 * science-targeting-engine.js — Context-aware targeting for promoted Science directives
 *
 ...
 *   Tier 3: Example entities (high-confidence well-known science sector players)
 *
 * ADDITIVE ONLY. Feature-flagged: window.LIMEN_ENABLE_DIRECTIVE_EXTRACTION
 * Exposes: window.LIMENScienceTargetingEngine
 */
(function () {
  'use strict';
  ...
  var SEGMENTS = {
    ...
    research_universities: {
      label: 'R1 research universities and university tech transfer offices',
    ...
    research_software: {
      label: 'Research informatics, ELN, and lab software',
      keywords: ['ELN', 'electronic lab notebook', 'LIMS', 'lab informatics', 'research data management', 'data repository', 'workflow', 'jupyter', 'notebook'],
      tier3: [
    ...
    research_integrity: {
      label: 'Research integrity, replication, and reproducibility tools',
      ...
      tier3: [
        ...
        { name: 'Open Science Framework (COS)', ticker: null },
    ...
    research_compute: {
      label: 'Research computing, HPC, and AI-for-science',
      keywords: ['HPC', 'supercomput', 'GPU cluster', 'AI for science', 'foundation model', 'research compute', 'cloud HPC', 'protein folding', 'molecular dynamics'],
      tier3: [
    ...
    foundations: {
      label: 'Private research foundations and philanthropy',
  ...
  window.LIMENScienceTargetingEngine = { resolveTargets: resolveTargets };
})();
