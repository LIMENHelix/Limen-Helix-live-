/*
 * technology-metaplasticity.js  — ADDITIVE meta-controller  (THE NEW STRATEGY)
 * ----------------------------------------------------------------------------
 * METAPLASTICITY build-target — the capstone that makes Technology's neuro-substrate SELF-TUNING.
 ...
 *   - offline down-scaling factor      (technology-offline-maintenance.js)
 *   - refractory absolute window       (technology-refractory-limiter.js)
 *   - prediction-error threshold       (technology-prediction-error-compressor.js)
 ...
 * no adaptation (returns inputs unchanged). Volatility is caller-supplied (Technology has no time
...
(function (root) {
  ...
  function adaptParams(current, params) {
    ...
    return {
      ...
      note: 'Pure. Applies nothing. gain operator-set; volatility caller-supplied (Technology has no time series).'
    };
  }

  var API = { adaptParams: adaptParams, DEFAULTS: DEFAULTS };
  if (typeof module !== 'undefined' && module.exports) module.exports = API;
  if (root && !root.TechnologyMetaplasticity) root.TechnologyMetaplasticity = API;
