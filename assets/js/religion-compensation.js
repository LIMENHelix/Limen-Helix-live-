...
(function () {
  ...
  var compensation = {
    ...
    byType: {
      grant: { label: 'Religion Grant Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
      patent: { label: 'Patent Execution', operatorBasePct: 0.08, operatorSuccessPct: 0.12 },
      loan: { label: 'Religion Loan Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
  ...
  window.LIMENReligion.economy.compensation = compensation;
