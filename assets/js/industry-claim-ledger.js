...
(function () {
  ...
  var STORE_KEY = 'LIMEN_INDUSTRY_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:industry-claim-update')); } catch (e) {}
  ...
  window.LIMENIndustry.economy.claims = {
