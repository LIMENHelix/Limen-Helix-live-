/**
 * education-compensation.js — Education Domain Compensation Model
 * Namespace: window.LIMENEducation.economy.compensation
 */
(function () {
  'use strict';
  ...
  var compensation = {
    ...
    byType: {
      grant: { label: 'Education Grant Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
      patent: { label: 'EdTech Patent Execution', operatorBasePct: 0.08, operatorSuccessPct: 0.12 },
      loan: { label: 'Education Loan Execution', operatorBasePct: 0.10, operatorSuccessPct: 0.15 },
  ...
  window.LIMENEducation.economy.compensation = compensation;
  console.log('[EducationCompensation] Loaded');
})();
