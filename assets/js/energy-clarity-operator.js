...
(function () {
  ...
  function buildActionQueue(state) {
    ...
    for (var i = 0; i < opps.length; i++) {
      ...
      // removed: GRANT / PATENT / BUILD buttons + execution workspace \u2014 lanes dropped (investment + research only)
      if (o.compensation) {
  ...
  function _renderOperatorDOM(state) {
    ...
    // removed: GRANT/PATENT/BUILD execution-workspace wiring — workspace lanes dropped
