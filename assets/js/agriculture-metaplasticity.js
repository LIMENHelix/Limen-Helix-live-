/*
 * agriculture-metaplasticity.js  — ADDITIVE meta-controller  (THE NEW STRATEGY)
 * ----------------------------------------------------------------------------
 * METAPLASTICITY build-target — the capstone that makes Agriculture's neuro-substrate SELF-TUNING.
 ...
 *   - offline down-scaling factor      (agriculture-offline-maintenance.js)
 *   - refractory absolute window       (agriculture-refractory-limiter.js)
 *   - prediction-error threshold       (agriculture-prediction-error-compressor.js)
 ...
 * no adaptation (returns inputs unchanged). Volatility is caller-supplied (Agriculture has no time
...
(function (root) {
  ...
  function adaptParams(current, params) {
    ...
    return {
      ...
      note: 'Pure. Applies nothing. gain operator-set; volatility caller-supplied (Agriculture has no time series).'
    };
  }

  var API = { adaptParams: adaptParams, DEFAULTS: DEFAULTS };
  if (typeof module !== 'undefined' && module.exports) module.exports = API;
  if (root && !root.AgricultureMetaplasticity) root.AgricultureMetaplasticity = API;
