/**
 * education-ei-balance.js — Excitation/Inhibition balance controller for the Education brain.
 *
 ...
 *
 * Dual export: window.EducationEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Education brain state, defensively. Never throws.
  ...
  if (root) root.EducationEIBalance = API;
