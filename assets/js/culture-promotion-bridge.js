/**
 * environment-promotion-bridge.js — Inject promoted Culture portal directives into operator surfaces
 *
 ...
 * Exposes: window.LIMENCulturePromotionBridge
 */
(function () {
  'use strict';
  ...
  function promote(state, portal, opts) {
    ...
    var extractor = window.LIMENCultureDirectiveExtractor;
    var ranker = window.LIMENCultureDirectiveRanker;
    var translator = window.LIMENCultureDirectiveTranslator;
    ...
    return extractor.extract(state, portal, opts)
      .then(function (candidates) {
        ...
        var targeting = window.LIMENCultureTargetingEngine;
        if (targeting) {
  ...
  window.LIMENCulturePromotionBridge = {
    promote: promote,
