/**
 * religion-ei-balance.js — Excitation/Inhibition balance controller for the Religion brain.
 *
 ...
 *
 * Dual export: window.ReligionEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Religion brain state, defensively. Never throws.
  ...
  if (root) root.ReligionEIBalance = API;
