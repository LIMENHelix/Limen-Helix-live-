/*
 * communication-refractory-limiter.js  — ADDITIVE reference implementation
 * ----------------------------------------------------------------------------
...
(function (root) {
  ...
  if (root && !root.CommunicationRefractoryLimiter) root.CommunicationRefractoryLimiter = API;
