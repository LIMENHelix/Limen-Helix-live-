/*
 * agriculture-prediction-error-compressor.js  — ADDITIVE reference implementation
 * ----------------------------------------------------------------------------
 * Concrete form of the PREDICTION_ERROR_COMPRESSION build-target
 * (docs/agriculture-prediction-error-compression-proposal.md).
 ...
 *
 * CONTRACT:
 *   - Pure/read-only. NEVER reads or writes assets/data/domains/p2_agri.json as a side effect.
...
(function (root) {
  ...
  if (root && !root.AgriculturePredictionErrorCompressor) root.AgriculturePredictionErrorCompressor = API;
