/**
 * governance-directive-ranker.js — Score and rank Governance directive candidates
 * Governance-native mechanisms. Exposes: window.LIMENGovernanceDirectiveRanker
 */
(function () {
  'use strict';
  ...
  // ── GOVERNANCE-NATIVE MECHANISMS ──
  var MECHANISMS = {
    institutional_capture: { label: 'Institutional Capture',     signals: ['regulatory capture', 'institutional capture', 'agency capture', 'revolving door', 'state capture', 'oligarch', 'special interest'] },
    policy_paralysis:      { label: 'Policy Paralysis',          signals: ['gridlock', 'paralysis', 'deadlock', 'shutdown', 'continuing resolution', 'filibuster', 'cloture', 'vote fail', 'unable to pass'] },
    legitimacy_erosion:    { label: 'Legitimacy Erosion',        signals: ['legitimacy', 'public trust', 'approval rating', 'distrust', 'cynicism', 'disillusion', 'voter confidence', 'institutional trust'] },
    corruption_signal:     { label: 'Corruption Signal',         signals: ['corruption', 'bribe', 'kickback', 'fraud', 'embezzle', 'self-dealing', 'conflict of interest', 'graft', 'pay-to-play'] },
    constitutional_strain: { label: 'Constitutional Strain',     signals: ['constitutional crisis', 'separation of powers', 'judicial independence', 'court packing', 'executive overreach', 'emergency powers'] },
    election_integrity:    { label: 'Election Integrity',        signals: ['election fraud', 'voter suppression', 'gerrymander', 'redistrict', 'ballot', 'recount', 'audit election', 'voter id'] },
    oversight_failure:     { label: 'Oversight Failure',         signals: ['oversight', 'inspector general', 'gao', 'audit failure', 'watchdog', 'whistleblower', 'inquiry', 'subpoena'] },
    diplomatic_strain:     { label: 'Diplomatic Strain',         signals: ['diplomacy', 'sanction', 'expel ambassador', 'recall envoy', 'embargo', 'trade war', 'summit', 'treaty withdraw', 'bilateral'] },
    civil_liberty_erosion: { label: 'Civil Liberty Erosion',     signals: ['civil liberty', 'civil rights', 'surveillance state', 'martial law', 'protest crackdown', 'freedom of assembly', 'press freedom'] },
    fiscal_crisis:         { label: 'Fiscal / Budget Crisis',    signals: ['debt ceiling', 'sovereign debt', 'fiscal cliff', 'budget crisis', 'austerity', 'deficit', 'bailout', 'default']  }
  };

  var DX_VALID_MECHANISMS = {
    'CONSTITUTIONAL_CRISIS':   ['constitutional_strain', 'oversight_failure', 'institutional_capture', 'civil_liberty_erosion'],
    'REGIME_INSTABILITY':      ['legitimacy_erosion', 'civil_liberty_erosion', 'constitutional_strain', 'corruption_signal'],
    'POLICY_FAILURE':          ['policy_paralysis', 'fiscal_crisis', 'institutional_capture', 'oversight_failure'],
    'CORRUPTION_SCANDAL':      ['corruption_signal', 'oversight_failure', 'institutional_capture', 'legitimacy_erosion'],
    'DIPLOMATIC_BREAKDOWN':    ['diplomatic_strain', 'legitimacy_erosion', 'fiscal_crisis', 'constitutional_strain'],
    'MILITARY_OVERREACH':      ['constitutional_strain', 'civil_liberty_erosion', 'oversight_failure', 'institutional_capture']
  };
  ...
  function rank(directives) {
    ...
    console.log('[GovernanceRanker] Ranked ' + directives.length);
    return directives;
  }

  window.LIMENGovernanceDirectiveRanker = { rank: rank };
})();
