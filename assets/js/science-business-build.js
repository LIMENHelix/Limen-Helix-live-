/**
 * science-business-build.js — BUSINESS BUILD Execution Workspace (Science)
 *
 * Science-native business launch system. Stages with science-native templates
 * (research startup, instrument vendor, biotech spinout, regtech-for-research,
 * lab services). 90-day execution plan, printable launch packet.
 *
 * Science domain only.
 * Exposes: window.LIMENScienceBusinessBuild
 */
(function () {
  'use strict';
  ...
  var isScience = _dom === 'science' || _dom === 'research';
  var isWorkspace = window.location.pathname.indexOf('science-workspace') !== -1;
  if (!isScience && !isWorkspace) return;

  var STORE_KEY = 'limen_science_business_build';
  ...
  var TEMPLATES = {
    'university_spinout': {
      label: 'University Research Spinout',
      ...
      fundingNotes: 'NSF I-Corps, SBIR Phase I/II ($275K-$2M), university gap funds, pre-seed angels, life science VCs.',
      ...
      first90: [
        ...
        'DAYS 61-90: Begin pre-seed/seed fundraising. Pitch to angel networks and life science VCs. Target $250K-$1M. OUTPUT: First investor commitments.'
      ]
    },
    'instrument_vendor': {
      label: 'Scientific Instrument / Reagent Vendor',
      description: 'A company that designs, manufactures, and sells laboratory equipment, reagents, or consumables to research labs. Examples: assay kits, fluidics, custom oligos, antibody panels.',
      ...
      fundingNotes: 'Self-funded, SBA 7(a) ($100K-$5M), equipment financing, life sciences VCs.',
      operatingNotes: 'Long sales cycles into research labs. Procurement through university purchasing. Trade shows (SLAS, Pittcon, AACR) drive lead generation.',
      first90: [
    ...
    'research_software': {
      label: 'Research Software / Informatics SaaS',
      description: 'A SaaS company building software for research labs. Examples: ELN, LIMS, bioinformatics, AI-for-science, lab automation, reproducibility tools.',
      ...
      fundingNotes: 'Pre-seed angels, SaaS-focused VCs, life sciences VCs. SBIR for science-specific tools.',
    ...
    'cro_lab_service': {
      label: 'Contract Research Organization (CRO) / Lab Service',
      ...
      fundingNotes: 'Self-funded, SBA loans for equipment, equipment financing, life sciences VCs for scale-up.',
    ...
    'research_consultancy': {
      label: 'Research Consultancy / Scientific Advisory',
      description: 'A consulting business providing scientific or methodological advisory services to research organizations, biotech, or pharma. Examples: statistical consulting, clinical trial design, biomarker strategy.',
  ...
  var STAGES = [
    ...
    { title: 'STAGE 2 - LEGAL & ENTITY', sections: [
      ...
      { id: 'compliance', title: 'Research / Regulatory Compliance', type: 'textarea', guidance: 'IRB / IACUC / IBC / GLP / GCP / CLIA / FDA requirements as applicable.' },
  ...
  window.LIMENScienceBusinessBuild = { renderPanel: renderPanel, wirePanel: wirePanel, STAGES: STAGES, TEMPLATES: TEMPLATES };
  console.log('[ScienceBusinessBuild] loaded \u2014 7 stages, 5 science-native templates');
})();
