/*
 * industry-metaplasticity.js  — ADDITIVE meta-controller  (THE NEW STRATEGY)
 * ----------------------------------------------------------------------------
 * METAPLASTICITY build-target — the capstone that makes Industry's neuro-substrate SELF-TUNING.
 ...
 *   - offline down-scaling factor      (industry-offline-maintenance.js)
 *   - refractory absolute window       (industry-refractory-limiter.js)
 *   - prediction-error threshold       (industry-prediction-error-compressor.js)
 ...
 * no adaptation (returns inputs unchanged). Volatility is caller-supplied (Industry has no time
...
(function (root) {
  ...
  function adaptParams(current, params) {
    ...
    return {
      ...
      note: 'Pure. Applies nothing. gain operator-set; volatility caller-supplied (Industry has no time series).'
    };
  }

  var API = { adaptParams: adaptParams, DEFAULTS: DEFAULTS };
  if (typeof module !== 'undefined' && module.exports) module.exports = API;
  if (root && !root.IndustryMetaplasticity) root.IndustryMetaplasticity = API;
