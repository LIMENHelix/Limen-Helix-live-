 ...
 *
 * Injects a small economics block into each Culture opportunity card
 ...
 * Namespace: window.LIMENCulture.economy.economics
 */
(function () {
  'use strict';
  ...
  window.LIMENCulture.economy.economics = {
