      ...
      execBtns[eb].addEventListener('click', function (e) {
        ...
        try {
          ...
          sessionStorage.setItem('limen_exec_context', JSON.stringify({
            ...
            source: 'finance',
            returnTo: '/domain-console?domain=finance&mode=operator'
          }));
        } catch (ex) {}
        var trackName = trackMap[execPath] || 'grant';
        window.location.href = 'finance-workspace.html?track=' + trackName + '&opp=' + encodeURIComponent(execKey) + '&returnTo=' + encodeURIComponent('/domain-console?domain=finance&mode=operator');
      });
    }
