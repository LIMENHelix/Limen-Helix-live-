/**
 * defense-targeting-engine.js — Context-aware targeting for promoted Defense directives
 * GLOBAL coverage — US, NATO, EU, AUKUS, allied, and adjacent commercial defense markets.
 * Exposes: window.LIMENDefenseTargetingEngine
 */
(function () {
  'use strict';
  ...
  var SEGMENTS = {
    us_dod_combatant: {
      ...
      tier3: [
        { name: 'U.S. Department of Defense (Pentagon)', ticker: null },
    ...
    us_intel_community: {
      ...
      tier3: [
        ...
        { name: 'DIA (Defense Intelligence Agency)', ticker: null },
        { name: 'NGA (National Geospatial-Intelligence Agency)', ticker: null },
        { name: 'In-Q-Tel (CIA strategic investor)', ticker: null }
      ]
    },
    us_defense_primes: {
      label: 'U.S. defense prime contractors',
      keywords: ['Lockheed', 'Raytheon', 'RTX', 'Northrop', 'General Dynamics', 'Boeing Defense', 'L3Harris', 'Huntington Ingalls', 'Leidos', 'BAH', 'CACI'],
      tier3: [
    ...
    european_defense_primes: {
      label: 'European defense prime contractors',
    ...
    asia_pacific_defense: {
      label: 'Asia-Pacific defense and allied primes',
    ...
    defense_tech_disruptors: {
      label: 'Defense-tech disruptors and venture-backed primes',
      ...
      tier3: [
        ...
        { name: 'Helsing (European defense AI)', ticker: null },
    ...
    sovereign_global_buyers: {
      label: 'Sovereign defense ministries and global FMS buyers',
      ...
      tier3: [
        ...
        { name: 'Japan Self-Defense Forces (JSDF)', ticker: null },
  ...
  // Map Defense top brain nodes to segments
  var NODE_SEGMENTS = {
  ...
  function resolveTargets(directive) {
    ...
    else if (path === 'PATENTABLE') executionTargets = ['Defense IP attorneys (35 USC 181 secrecy aware)', 'Defense prime tech transfer offices', 'Allied defense ministries', 'Strategic acquirers in defense-tech (Anduril, Palantir, Shield AI)'];
    else if (path === 'INVESTABLE') executionTargets = ['Defense-focused VCs (8VC, Founders Fund, a16z American Dynamism, Lux Capital)', 'In-Q-Tel', 'Sovereign wealth funds with defense mandates', 'Family offices with defense exposure'];
  ...
  window.LIMENDefenseTargetingEngine = { resolveTargets: resolveTargets };
})();
