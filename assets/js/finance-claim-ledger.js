/**
 * finance-claim-ledger.js — Finance Domain Claim Ledger (Local Only)
 *
 * Stores claim records in localStorage. Tracks opportunity claims
 * from acceptance through outcome. Finance-scoped only.
 *
 * Namespace: window.LIMENFinance.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_FINANCE_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:finance-claim-update')); } catch (e) {}
  ...
  window.LIMENFinance.economy.claims = {
  ...
  console.log('[FinanceClaimLedger] Loaded — claim ledger ready');
})();
