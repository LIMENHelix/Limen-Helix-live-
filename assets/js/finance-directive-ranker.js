...
(function () {
  ...
  var MECHANISMS = {
    credit_contraction:   { label: 'Credit Contraction',      signals: ['credit', 'lending', 'loan', 'mortgage', 'underwriting', 'default', 'delinquency', 'npl'] },
    market_dislocation:   { label: 'Market Dislocation',      signals: ['market', 'equity', 'index', 'correction', 'crash', 'bubble', 'valuation', 'multiple'] },
    liquidity_crisis:     { label: 'Liquidity Crisis',        signals: ['liquidity', 'redemption', 'margin', 'collateral', 'repo', 'interbank', 'funding', 'cash'] },
    currency_stress:      { label: 'Currency Stress',         signals: ['currency', 'fx', 'exchange rate', 'devaluation', 'peg', 'reserves', 'capital flight'] },
    systemic_contagion:   { label: 'Systemic Contagion',      signals: ['systemic', 'contagion', 'counterparty', 'interconnect', 'cascad', 'domino', 'too big'] },
    regulatory_shock:     { label: 'Regulatory Shock',        signals: ['regulatory', 'regulation', 'compliance', 'enforcement', 'fine', 'penalty', 'sanction', 'ban'] },
    interest_rate_impact: { label: 'Interest Rate Impact',    signals: ['interest rate', 'yield', 'duration', 'spread', 'inversion', 'basis point', 'fed fund'] },
    insurance_disruption: { label: 'Insurance Disruption',    signals: ['insurance', 'underwriting', 'claims', 'reinsurance', 'actuarial', 'catastrophe', 'loss ratio'] },
    fraud_exposure:       { label: 'Fraud Exposure',          signals: ['fraud', 'accounting', 'misrepresent', 'ponzi', 'embezzle', 'insider', 'manipulat', 'scandal'] },
    capital_structure:    { label: 'Capital Structure',       signals: ['capital', 'equity', 'debt', 'leverage', 'restructuring', 'bankruptcy', 'covenant', 'tier 1'] }
  };

  // Which mechanisms are VALID for each diagnosis
  var DX_VALID_MECHANISMS = {
    'BANKING_CRISIS':      ['credit_contraction', 'liquidity_crisis', 'systemic_contagion', 'capital_structure', 'regulatory_shock', 'interest_rate_impact'],
    'CREDIT_FREEZE':       ['credit_contraction', 'liquidity_crisis', 'interest_rate_impact', 'capital_structure', 'market_dislocation'],
    'MARKET_CRASH':        ['market_dislocation', 'liquidity_crisis', 'systemic_contagion', 'interest_rate_impact', 'capital_structure'],
    'CURRENCY_COLLAPSE':   ['currency_stress', 'liquidity_crisis', 'capital_structure', 'systemic_contagion', 'regulatory_shock'],
    'SYSTEMIC_CONTAGION':  ['systemic_contagion', 'liquidity_crisis', 'credit_contraction', 'market_dislocation', 'capital_structure', 'currency_stress'],
    'FRAUD_SCANDAL':       ['fraud_exposure', 'regulatory_shock', 'capital_structure', 'market_dislocation', 'credit_contraction']
  };
  ...
  window.LIMENFinanceDirectiveRanker = { rank: rank };
})();
