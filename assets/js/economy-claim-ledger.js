/**
 * economy-claim-ledger.js — Economy Domain Claim Ledger (Local Only)
 *
 * Stores claim records in localStorage. Tracks opportunity claims
 * from acceptance through outcome. Economy-scoped only.
 *
 * Namespace: window.LIMENEconomy.economy.claims
 */
(function () {
  'use strict';
  ...
  var STORE_KEY = 'LIMEN_ECONOMY_CLAIMS';
  ...
  function createClaimRecord(opportunity) {
    ...
    try { window.dispatchEvent(new CustomEvent('limen:economy-claim-update')); } catch (e) {}
  ...
  window.LIMENEconomy.economy.claims = {
  ...
  console.log('[EconomyClaimLedger] Loaded — claim ledger ready');
})();
