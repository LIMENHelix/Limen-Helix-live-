/**
 * governance-ei-balance.js — Excitation/Inhibition balance controller for the Governance brain.
 *
 ...
 *
 * Dual export: window.GovernanceEIBalance (browser) + module.exports (server/cron/tests).
 */
(function (root) {
  'use strict';
  ...
  /**
   * Derive drive + inhibition from a live Governance brain state, defensively. Never throws.
  ...
  if (root) root.GovernanceEIBalance = API;
