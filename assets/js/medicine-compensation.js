/**
 * medicine-compensation.js — Medicine Domain Compensation Model
 *
 * Defines operator compensation rates by opportunity type.
 * Medicine-scoped only. No backend. No payment processing.
 *
 * Namespace: window.LIMENMedicine.economy.compensation
 */
(function () {
  'use strict';
  ...
  window.LIMENMedicine.economy.compensation = compensation;

  console.log('[MedicineCompensation] Loaded — compensation model ready');
})();
