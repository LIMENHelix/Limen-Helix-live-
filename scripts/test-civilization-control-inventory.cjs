...
assert.equal(snap.summary.cadencePumps, 55, 'every declared Vercel cadence is visible');
...
console.log('civilization control inventory: 22 runtime valves, all env controls, 55 cadences, 385 triggers, 111 diagnoses, B0-B17 and P0-P10 visible');
