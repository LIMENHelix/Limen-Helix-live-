...
const bindings = [
  ...
  { file: 'lib/communication-video-upload-bridge.js', guard: 'AdapterGuard).checkpoint', effect: "status: 'PROVIDER_CALL_AUTHORIZED', uploadAuthorizationId", valves: ['communication:youtube'] },
