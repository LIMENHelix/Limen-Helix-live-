...
assert('the shared router exposes exactly the five built authorities', R.SUPPORTED.join(',') === 'gallup_religious_attendance,scotus_docket,us_courts_caseload,uscirf_annual_report,wjp_rol_index', R.SUPPORTED.join(','));
