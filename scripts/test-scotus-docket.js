...
assert('router exposes exactly four implemented authorities', R.SUPPORTED.join(',') === 'gallup_religious_attendance,scotus_docket,us_courts_caseload,wjp_rol_index', R.SUPPORTED.join(','));
