...
const ledger = Ledger.build({ financeCycle: cycle, financePacket: { sourceType: 'server-cognition-refresh', generatedAt: '2026-08-24T16:01:00Z' }, company: { slug: 'example_co', ticker: 'EX' }, semanticEvidence: semantic, marketData: market, networkEvidence: network, thing1: { applicable: false, reason: 'not-supplied' }, thing2: { applicable: false, reason: 'not-supplied' }, candidate: { lane: 'investment', status: 'READY_TO_FIRE', id: 'explicit-input-candidate' }, now: '2026-08-24T16:01:00Z' });
