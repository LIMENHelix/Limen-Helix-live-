...
global.fetch = async function (url) {
  ...
  else if (text.indexOf('markets.newyorkfed.org') >= 0) body = { refRates: [
    { effectiveDate: '2026-08-20', percentRate: 3.63 }
  ] };
...
(async function () {
  try {
    ...
    assert.equal((await nyFed()).sourceUpdatedAt, '2026-08-20');
