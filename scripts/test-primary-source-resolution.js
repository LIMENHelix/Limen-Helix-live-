...
var good = RES.normalizeCrossref(
  { domain: 'science', identifierType: 'DOI', identifier: '10.1234/example' },
...
RES.resolveQueue({ tasks: [{ domain: 'science', identifierType: 'DOI', identifier: '10.1234/example' }] }, async function () {
