...
t('server refresh failure is explicit', function () { assert.ok(evidence.observations.every(function(o){return o.provenanceAbstentions.some(function(x){return /server-to-server/.test(x));}))); });
