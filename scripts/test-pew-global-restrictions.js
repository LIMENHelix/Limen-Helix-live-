...
t('shared router exposes exactly nine implemented authorities', function () {
  assert.strictEqual(R.SUPPORTED.join(','),
    'arda_congregational_trends,ats_seminary_enrollment,gallup_religious_attendance,interfaith_america_pluralism,pew_global_restrictions,scotus_docket,us_courts_caseload,uscirf_annual_report,wjp_rol_index');
