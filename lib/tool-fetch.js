...
module.exports = { getJSON: getJSON, postJSON: postJSON, getText: getText, cached: cached, cachedQuery: cachedQuery, cleanQuery: cleanQuery, slugKey: slugKey, send: send };
