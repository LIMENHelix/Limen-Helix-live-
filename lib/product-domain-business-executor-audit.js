...
var BINDINGS = {
  ...
  communication: {
    ...
    executor: [{ file: 'handlers/social-cron.js', tokens: [
      'selectPublishableCandidate(selection.ready, motorStore', 'socialDecision.decide',
      'if (!releaseSelection.ok)', 'releaseSelection.channelDecision', 'socialExecutor.execute({',
  ...
  supplyChain: {
    ...
    executor: [
      ...
      { file: 'lib/trade-auction-executor.js', tokens: ['(i.motorAuthorization || Motor).authorize(', '"supplyChain"', 'i.marketplace.createListing({'] }
    ],
    receipt: [{ file: 'lib/trade-auction-executor.js', tokens: ['status: "DISPATCHING"', 'c.status = c.listingId', 'listingId', 'durableReceiptReadbackVerified = true'] }],
  ...
  economy: {
    lane: 'investments',
    executor: [
      { file: 'handlers/economy-investment-cycle.js', tokens: ["Db.lrangeStrict)('feedtitles:economy'", "Redis.redisGet)('limen:brain:cognition:economy'", 'Executor).execute({'] },
      { file: 'lib/economy-investment-executor.js', tokens: ["authorize(store, 'economy', 'investments'", 'b14.createPreview', 'b14.submitApproved', "productionAdapterContract: 'broker-equity-order-adapter/1'"] }
    ],
    receipt: [{ file: 'lib/economy-investment-executor.js', tokens: ["status = command.brokerOrderId ? 'COMMAND_RECEIPTED'", 'brokerOrderId', 'durableReceiptReadbackVerified = true', 'action receipt readback invalid'] }],
    receiptStrength: 'DURABLE_B10_B14_DOMAIN_OWNED_PAPER_BROKER_RECEIPT',
    switchBudget: [
      { file: 'handlers/economy-investment-cycle.js', tokens: ['ECONOMY_INVESTMENT_PAPER_ENABLED', 'ECONOMY_INVESTMENT_MAX_NOTIONAL_USD', 'ECONOMY_INVESTMENT_DAILY_NOTIONAL_USD', 'ECONOMY_INVESTMENT_DAILY_ORDER_CAP'] },
      { file: 'lib/economy-investment-executor.js', tokens: ['ECONOMY_INVESTMENT_PAPER_ORDER_ENABLED', 'ECONOMY_INVESTMENT_RECOVERY_ENABLED', 'candidate-exceeds-conservative-budget-slot'] }
    ],
    rollback: [
      { file: 'handlers/economy-investment-recovery.js', tokens: ["Admin.hasDomain(Admin.reqKey(req), 'economy')", 'Recovery.recover({'] },
      { file: 'lib/economy-investment-recovery.js', tokens: ["authorize(store, 'economy', 'investments'", 'b14.cancelApproved', 'b14.createPreview', "status = 'CLOSE_COMMAND_RECEIPTED'", 'rollbackReadbackVerified = true'] }
    ],
    rollbackNote: 'fresh Economy recovery authority cancels an unfilled paper order or submits an identity-bound opposite-side close for measured filled exposure',
    observer: [
      { file: 'handlers/economy-investment-outcome-observer.js', tokens: ['Observer.inspectCommand', 'Outcome.recordAutonomousOutcome', "ownerDomain !== 'economy'", "orderSubmissionCalls: 0"] },
      { file: 'lib/autofire-investment-observer.js', tokens: ["ownerDomain = String(intent.ownerDomain || 'finance')", 'horizonDays: horizon'] }
    ],
    observerScope: 'ECONOMY_PAPER_30_60_90_INDEPENDENT_ACCOUNT_AND_MARKET_RESOLUTION'
  },
  energy: {
    lane: 'investments',
    executor: [
      { file: 'handlers/energy-investment-cycle.js', tokens: ["Db.lrangeStrict)('feedtitles:energy'", "Redis.redisGet)('limen:brain:cognition:energy'", 'Executor).execute({'] },
      { file: 'lib/energy-investment-executor.js', tokens: ["authorize(store, 'energy', 'investments'", 'b14.createPreview', 'b14.submitApproved', "productionAdapterContract: 'broker-equity-order-adapter/1'"] }
    ],
    receipt: [{ file: 'lib/energy-investment-executor.js', tokens: ["status = command.brokerOrderId ? 'COMMAND_RECEIPTED'", 'brokerOrderId', 'durableReceiptReadbackVerified = true', 'action receipt readback invalid'] }],
    receiptStrength: 'DURABLE_B10_B14_DOMAIN_OWNED_PAPER_BROKER_RECEIPT',
    switchBudget: [
      { file: 'handlers/energy-investment-cycle.js', tokens: ['ENERGY_INVESTMENT_PAPER_ENABLED', 'ENERGY_INVESTMENT_MAX_NOTIONAL_USD', 'ENERGY_INVESTMENT_DAILY_NOTIONAL_USD', 'ENERGY_INVESTMENT_DAILY_ORDER_CAP'] },
      { file: 'lib/energy-investment-executor.js', tokens: ['ENERGY_INVESTMENT_PAPER_ORDER_ENABLED', 'ENERGY_INVESTMENT_RECOVERY_ENABLED', 'candidate-exceeds-conservative-budget-slot'] }
    ],
    rollback: [
      { file: 'handlers/energy-investment-recovery.js', tokens: ["Admin.hasDomain(Admin.reqKey(req), 'energy')", 'Recovery.recover({'] },
      { file: 'lib/energy-investment-recovery.js', tokens: ["authorize(store, 'energy', 'investments'", 'b14.cancelApproved', 'b14.createPreview', "status = 'CLOSE_COMMAND_RECEIPTED'", 'rollbackReadbackVerified = true'] }
    ],
    rollbackNote: 'fresh Energy recovery authority cancels an unfilled paper order or submits an identity-bound opposite-side close for measured filled exposure',
    observer: [
      { file: 'handlers/energy-investment-outcome-observer.js', tokens: ['Observer.inspectCommand', 'Outcome.recordAutonomousOutcome', "ownerDomain !== 'energy'", "orderSubmissionCalls: 0"] },
      { file: 'lib/autofire-investment-observer.js', tokens: ["ownerDomain = String(intent.ownerDomain || 'finance')", 'horizonDays: horizon'] }
    ],
    observerScope: 'ENERGY_PAPER_30_60_90_INDEPENDENT_ACCOUNT_AND_MARKET_RESOLUTION'
  },
  technology: {
    lane: 'investments',
    executor: [
      { file: 'handlers/technology-investment-cycle.js', tokens: ["Db.lrangeStrict)('feedtitles:technology'", "Redis.redisGet)('limen:brain:cognition:technology'", 'Executor).execute({'] },
      { file: 'lib/technology-investment-executor.js', tokens: ["authorize(store, 'technology', 'investments'", 'b14.createPreview', 'b14.submitApproved', "productionAdapterContract: 'broker-equity-order-adapter/1'"] }
    ],
    receipt: [{ file: 'lib/technology-investment-executor.js', tokens: ["status = command.brokerOrderId ? 'COMMAND_RECEIPTED'", 'brokerOrderId', 'durableReceiptReadbackVerified = true', 'action receipt readback invalid'] }],
    receiptStrength: 'DURABLE_B10_B14_DOMAIN_OWNED_PAPER_BROKER_RECEIPT',
    switchBudget: [
      { file: 'handlers/technology-investment-cycle.js', tokens: ['TECHNOLOGY_INVESTMENT_PAPER_ENABLED', 'TECHNOLOGY_INVESTMENT_MAX_NOTIONAL_USD', 'TECHNOLOGY_INVESTMENT_DAILY_NOTIONAL_USD', 'TECHNOLOGY_INVESTMENT_DAILY_ORDER_CAP'] },
      { file: 'lib/technology-investment-executor.js', tokens: ['TECHNOLOGY_INVESTMENT_PAPER_ORDER_ENABLED', 'TECHNOLOGY_INVESTMENT_RECOVERY_ENABLED', 'candidate-exceeds-conservative-budget-slot'] }
    ],
    rollback: [
      { file: 'handlers/technology-investment-recovery.js', tokens: ["Admin.hasDomain(Admin.reqKey(req), 'technology')", 'Recovery.recover({'] },
      { file: 'lib/technology-investment-recovery.js', tokens: ["authorize(store, 'technology', 'investments'", 'b14.cancelApproved', 'b14.createPreview', "status = 'CLOSE_COMMAND_RECEIPTED'", 'rollbackReadbackVerified = true'] }
    ],
    rollbackNote: 'fresh Technology recovery authority cancels an unfilled paper order or submits an identity-bound opposite-side close for measured filled exposure',
    observer: [
      { file: 'handlers/technology-investment-outcome-observer.js', tokens: ['Observer.inspectCommand', 'Outcome.recordAutonomousOutcome', "ownerDomain !== 'technology'", "orderSubmissionCalls: 0"] },
      { file: 'lib/autofire-investment-observer.js', tokens: ["ownerDomain = String(intent.ownerDomain || 'finance')", 'horizonDays: horizon'] }
    ],
    observerScope: 'TECHNOLOGY_PAPER_30_60_90_INDEPENDENT_ACCOUNT_AND_MARKET_RESOLUTION'
  },
  intelligence: {
    lane: 'autopilot',
  ...
  industry: {
    lane: 'crm',
    executor: [{ file: 'handlers/industry-ingest.js', tokens: ['crmQueue.enqueueFromWarn(motorStore, body.deals'] }, { file: 'handlers/industry-crm-cycle.js', tokens: ['Decision).decide(store,task.candidate', 'Executor).execute({'] }, { file: 'lib/industry-crm-executor.js', tokens: ['(i.motorAuthorization || Motor).authorize(', '"industry"', 'i.provider.create(v)'] }],
    receipt: [{ file: 'lib/industry-crm-executor.js', tokens: ['status: "DISPATCHING"', 'c.status =', 'hubspotCompanyId', 'readbackVerified = true'] }],
  ...
  religion: {
    ...
    executor: [{ file: 'handlers/subscriber-digest.js', tokens: [
      'subs.activeListStrict()', 'motor.decision.decide(motorStore, candidate', 'groupMotor.executor.execute({',
      'crm.sendToLead(email, subject, body, options)', 'subs.markSentStrict('
    ] }, { file: 'handlers/stripe-webhook.js', tokens: [
      'subs.activateStrict({', 'fulfillmentFor(act.subscriber.domain)', 'enqueueFulfillment(welcomeMotor',
      'subs.getStrict(email, motorStore)', 'fulfillmentFor(who.domain)', 'enqueueFulfillment(renewalMotor', 'subs.deactivateStrict('
...
var LANE_SURFACES = {
  ...
  'investments': { files: ['handlers/economy-investment-cycle.js', 'handlers/economy-investment-outcome-observer.js', 'handlers/energy-investment-cycle.js', 'handlers/energy-investment-outcome-observer.js', 'handlers/technology-investment-cycle.js', 'handlers/technology-investment-outcome-observer.js'], status: 'DOMAIN_BOUND_PAPER_EXECUTORS_ECONOMY_ENERGY_AND_TECHNOLOGY' },
