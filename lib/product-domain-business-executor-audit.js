...
var BINDINGS = {
  ...
  religion: {
    ...
    executor: [{ file: 'handlers/subscriber-digest.js', tokens: [
      ...
      'subs.activateStrict({', 'fulfillmentFor(act.subscriber.domain)', 'welcomeMotor.enqueueAndAttempt({',
      'subs.getStrict(email, motorStore)', 'fulfillmentFor(who.domain)', 'renewalMotor.enqueueAndAttempt({', 'subs.deactivateStrict(',
      'g0DeskFulfillment.owns(id)'
