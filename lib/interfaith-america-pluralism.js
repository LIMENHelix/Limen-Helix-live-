...
function descriptor() {
  return {
    authority: AUTHORITY,
    domain: 'religion',
    title: 'Interfaith America pluralism network · provider-output snapshot',
    ...
    operatorUse: 'Inspect where the provider reports activity across campus, civic, workplace, health, learning, and communications programs. Use each row as a source-linked lead for follow-up, never as a pluralism outcome or composite.',
    ...
    boundaries: [
      ...
      'This annual snapshot may not drive the 30-second loop or directly create stress, a diagnosis, or pathway activation.',
