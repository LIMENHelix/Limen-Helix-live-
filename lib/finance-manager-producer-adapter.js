...
var MANAGER_SCHEMA = 'finance-manager-proposal/1.1';
var PRODUCER_SCHEMA = 'finance-opportunity-proposal/1.1';
...
function adapt(parsed) {
  ...
  if ([1, 3, 7, 14, 30, 60, 90].indexOf(p.horizonDays) < 0) blockers.push('manager_proposal_horizon_required');
  ...
  return {
    ...
    proposal: {
      ...
      projectedMarginRanking: clone(p.projectedMarginRanking || null),
