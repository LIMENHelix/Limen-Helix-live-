...
// (confidence). Blend the remainder toward the CISS floor (the measured company-stress composite).
...
// When the estimate is diffuse, the honest, conservative floor is the direct company reading, not a
// smear across half the arc. cissFloor null/absent => raw mass is used unblended (no behavior change
// for a domain whose CISS could not ground).
