...
var DIAGNOSTIC_ROUTES = new Set([
  ...
  'social-status', 'homestead-status', 'industry-status', 'finance-distress-status', 'civilization-treasury',
  'energy-distress-status', 'research-paper-developmental-status', 'product-domain-learning-state',
  'domain-commercial-status'
]);
...
var COGNITION_ROUTES = new Set([
  ...
  'domain-commercial-reflex', 'domain-commercial-artifact-prep', 'domain-video-manifest-prep'
]);
