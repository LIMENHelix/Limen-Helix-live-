...
var EXTRA_ENV_CONTROLS = [
  ...
  'DOMAIN_AGENT_DAILY_CAP', 'DOMAIN_AGENT_MAX_TOKENS', 'DOMAIN_AGENT_PROVIDER', 'DOMAIN_AGENT_HF_MODEL',
  'DOMAIN_AGENT_HF_BILL_TO', 'DOMAIN_AGENT_TIMEOUT_MS', 'HF_TOKEN', 'HUGGING_FACE_HUB_TOKEN',
  ...
  'SUBSCRIBER_EMAIL_AUTONOMY_ENABLED', 'SUBSCRIBER_EMAIL_OUTCOME_OBSERVER_ENABLED',
  'SUBSCRIBER_EMAIL_MAX_SENDS', 'SUBSCRIBER_EMAIL_USD',
  'SUBSCRIBER_EMAIL_DAILY_BUDGET_USD', 'SUBSCRIBER_EMAIL_DAILY_SEND_CAP',
  ...
  'LIMEN_FINANCE_POSITION_OWNER_ENABLED', 'LIMEN_FINANCE_SANDBOX_RESERVE_USD',
