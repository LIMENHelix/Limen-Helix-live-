...
function build(declaration) {
  ...
  return Object.freeze({
    ...
    videoManifestPrefix: 'domain_commercial:video-manifest:' + domain + ':',
    videoManifestStateKey: 'domain_commercial:video-manifest-state:' + domain,
    videoManifestLog: 'domain_commercial:video-manifest-log:' + domain,
