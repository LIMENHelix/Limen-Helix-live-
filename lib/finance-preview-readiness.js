...
function build(input) {
  ...
  var learningByCik = Object.create(null);
  list(input.companyLearningPatterns).forEach(function (row) {
    if (row && row.cik != null) learningByCik[normalizedCik(row.cik)] = row;
  });
  var universe = Source.assemble({
    ...
    companyLearningByCik: learningByCik,
