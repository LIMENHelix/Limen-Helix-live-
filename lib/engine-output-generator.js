 ...
 * patent/grant/sba/franchise retired 2026-06-15, out{} keys kept empty for back-compat).
 *
...
function generateForPortal(portal, opts) {
  ...
  for (const bridge of bridges) {
    // Retired lanes (patent/grant/sba/franchise) — no longer generated; keys kept
    // empty for back-compat. Only investment + research remain active.
