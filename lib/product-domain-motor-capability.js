...
async function verifyPair(store, motorReceipt, now) {
  ...
  return verifyPairReceipts(executor, observer, motorReceipt, now);
}

function verifyPairReceipts(executor, observer, motorReceipt, now) {
...
module.exports = {
  ...
  validate: validate,
  verifyPairReceipts: verifyPairReceipts,
