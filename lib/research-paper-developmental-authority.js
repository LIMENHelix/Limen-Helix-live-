...
/**
 * One-attempt bootstrap authority for explicitly registered paper pilots.
 *
...
var OWNERS = {
  ...
  education: {
    productDomain: 'education', ownerDomain: 'education', contractId: 'education-motor/1',
    lane: 'research-papers', budgetId: 'education-research-budget/1',
    switchName: 'LIMEN_EDUCATION_RESEARCH_DEVELOPMENTAL_ENABLED'
  },
  environment: {
    productDomain: 'environment', ownerDomain: 'environment', contractId: 'environment-motor/1',
    lane: 'research-papers', budgetId: 'environment-research-budget/1',
    switchName: 'LIMEN_ENVIRONMENT_RESEARCH_DEVELOPMENTAL_ENABLED'
  }
};
