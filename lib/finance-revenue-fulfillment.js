...
async function fulfill(input) {
  ...
  var policy = SubscriberPolicy.resolve(process.env, { enabled: 'FINANCE_SUBSCRIBER_EMAIL_ENABLED',
    observerEnabled: 'FINANCE_SUBSCRIBER_OUTCOME_OBSERVER_ENABLED', maxSends: 'FINANCE_SUBSCRIBER_MAX_SENDS',
    emailCostUsd: 'FINANCE_SUBSCRIBER_EMAIL_USD', dailyBudgetUsd: 'FINANCE_SUBSCRIBER_DAILY_BUDGET_USD',
