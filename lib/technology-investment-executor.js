...
var Learning = require('./technology-investment-learning.js');
...
async function execute(options) {
  ...
  try {
    ...
    if (!learnedCause || !learnedCause.ok || !learnedCause.command) throw new Error('technology investment causal command memory unavailable');
    ...
    var brokerCommand = await b14.submitApproved(store, broker, {
      ...
      approval: { mode: 'domain-autonomous', actor: 'technology-brain', ownerDomain: 'technology',
