...
function audit() {
  ...
  var domains = product.domains.map(function (row) {
    ...
    var localRequired = [
      ...
      'emissionQueue', 'autonomousInternalEmission'
    ];
  ...
  return {
    schemaVersion: 'product-domain-energy-parity-audit/1.1',
    ...
    referencePosture: {
      ...
      outcome: 'NEXT-CYCLE_SELF_CONSISTENCY_NOT_AN_INDEPENDENT_BUSINESS_OUTCOME',
