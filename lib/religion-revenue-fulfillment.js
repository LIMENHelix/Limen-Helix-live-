...
async function fulfill(input) {
  ...
  var policy = SubscriberPolicy.resolve(process.env, { enabled: 'RELIGION_SUBSCRIBER_EMAIL_ENABLED',
    observerEnabled: 'RELIGION_SUBSCRIBER_OUTCOME_OBSERVER_ENABLED', maxSends: 'SUBSCRIBER_DIGEST_MAX_SENDS',
    emailCostUsd: 'RELIGION_SUBSCRIBER_EMAIL_USD', dailyBudgetUsd: 'RELIGION_SUBSCRIBER_DAILY_BUDGET_USD',
