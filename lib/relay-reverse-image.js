...
/** Marketplaces we can plausibly source from. Anything else is a dead-end link. */
const SOURCEABLE = [
  'ebay.com', 'ebay.co.uk', 'poshmark.com', 'mercari.com', 'vinted.com', 'vinted.co.uk',
  'depop.com', 'grailed.com', 'therealreal.com', 'thredup.com', 'etsy.com',
  'offerup.com', 'craigslist.org', 'facebook.com', 'shopgoodwill.com', 'ebth.com'
];
...
function isSourceable(url) {
  const h = hostOf(url);
  return SOURCEABLE.some(function (d) { return h === d || h.endsWith('.' + d); });
}
