...
var CATALOG = {
  ...
  "communication": {
    ...
    "rungs": {
      "p1": {
        "name": "A New FCC Action In Your Lane",
        "line": "A rule, notice or licence action first appears for the proceeding, licence or band you follow.",
        "cadence": "daily, as the Register publishes",
        "shape": "event",
        "priceCents": 800
      },
      "p2": {
        "name": "Your FCC Docket Read",
        "line": "New FCC actions touching the proceedings, licences or bands you follow.",
        "cadence": "daily",
        "shape": "rhythm",
        "priceCents": 400
      }
  ...
  "culture": {
    ...
    "rungs": {
      "p2": {
        "name": "Your Royalty and Audience Read",
        "line": "What your streams actually pay, and where attention is moving in the lanes you name.",
        "cadence": "monthly",
        "shape": "rhythm",
        "priceCents": 400
      }
  ...
  "energy": {
    ...
    "rungs": {
      "p2": {
        "name": "Your Utility Rate Watch",
        "line": "Rate and bill-pressure for the utility or state you name, re-cut as new readings land.",
        "cadence": "monthly, as bills and readings arrive",
        "shape": "rhythm",
        "priceCents": 400
      }
    }
  ...
  "industry": {
    ...
    "rungs": {
      "p1": {
        "name": "A Park-It Recall On Your Vehicle",
        "line": "NHTSA first flags your year, make and model as do-not-drive or do-not-garage.",
        "cadence": "same day NHTSA posts",
        "shape": "event",
        "priceCents": 800
      },
      "p2": {
        "name": "Your Vehicle Recall Brief",
        "line": "Open safety recalls on the vehicle you actually drive, refreshed as NHTSA republishes.",
        "cadence": "per NHTSA update",
        "shape": "rhythm",
        "priceCents": 400
      }
    }
  ...
  "infrastructure": {
    ...
    "rungs": {
      "p1": {
        "name": "A Ground Stop At Your Airport",
        "line": "FAA first posts a ground stop, delay program or closure at an airport you watch.",
        "cadence": "same hour as FAA posts",
        "shape": "event",
        "priceCents": 800
      },
      "p2": {
        "name": "Your Airport and Corridor Watch",
        "line": "Ground stops, delays and closures for the airports, corridors or facilities you name.",
        "cadence": "as FAA updates, about every ten minutes",
        "shape": "rhythm",
        "priceCents": 400
      }
    }
