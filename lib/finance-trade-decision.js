...
var PROPOSAL_SCHEMA = 'finance-trade-decision-proposal/1.1';
...
var SYSTEM = [
  ...
  'The schema is finance-trade-decision-proposal/1.1.',
  'Choose BUY, SELL, SHORT, COVER, or ABSTAIN for the supplied company only.',
  'Re-read the supplied current exact-issuer feedConfirmation before deciding. Use only supplied evidence and copy every evidenceRefs entry exactly.',
